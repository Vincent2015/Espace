...
(function(){function a(a){return 10>a?"0"+a:a}function c(a){f.lastIndex=0;return f.test(a)?'"'+a.replace(f,function(a){var c=n[a];return"string"===typeof c?c:"\\u"+("0000"+a.charCodeAt(0).toString(16)).slice(-4)})+'"':'"'+a+'"'}function d(a,e){var f,n,m,x,y=g,u,r=e[a];r&&"object"===typeof r&&"function"===typeof r.toJSON&&(r=r.toJSON(a));"function"===typeof v&&(r=v.call(e,a,r));switch(typeof r){case "string":return c(r);case "number":return isFinite(r)?String(r):"null";case "boolean":case "null":return String(r);
case "object":if(!r)return"null";g+=k;u=[];if("[object Array]"===Object.prototype.toString.apply(r)){x=r.length;for(f=0;f<x;f+=1)u[f]=d(f,r)||"null";m=0===u.length?"[]":g?"[\n"+g+u.join(",\n"+g)+"\n"+y+"]":"["+u.join(",")+"]";g=y;return m}if(v&&"object"===typeof v)for(x=v.length,f=0;f<x;f+=1)"string"===typeof v[f]&&(n=v[f],(m=d(n,r))&&u.push(c(n)+(g?": ":":")+m));else for(n in r)Object.prototype.hasOwnProperty.call(r,n)&&(m=d(n,r))&&u.push(c(n)+(g?": ":":")+m);m=0===u.length?"{}":g?"{\n"+g+u.join(",\n"+
g)+"\n"+y+"}":"{"+u.join(",")+"}";g=y;return m}}"function"!==typeof Date.prototype.toJSON&&(Date.prototype.toJSON=function(){return isFinite(this.valueOf())?this.getUTCFullYear()+"-"+a(this.getUTCMonth()+1)+"-"+a(this.getUTCDate())+"T"+a(this.getUTCHours())+":"+a(this.getUTCMinutes())+":"+a(this.getUTCSeconds())+"Z":null},String.prototype.toJSON=Number.prototype.toJSON=Boolean.prototype.toJSON=function(){return this.valueOf()});var e,f,g,k,n,v;"function"!==typeof JSON.stringify&&(f=/[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,
n={"\b":"\\b","\t":"\\t","\n":"\\n","\f":"\\f","\r":"\\r",'"':'\\"',"\\":"\\\\"},JSON.stringify=function(a,c,e){var f;k=g="";if("number"===typeof e)for(f=0;f<e;f+=1)k+=" ";else"string"===typeof e&&(k=e);if((v=c)&&"function"!==typeof c&&("object"!==typeof c||"number"!==typeof c.length))throw Error("JSON.stringify");return d("",{"":a})});"function"!==typeof JSON.parse&&(e=/[\u0000\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,JSON.parse=function(a,
c){function d(a,e){var f,g,k=a[e];if(k&&"object"===typeof k)for(f in k)Object.prototype.hasOwnProperty.call(k,f)&&(g=d(k,f),void 0!==g?k[f]=g:delete k[f]);return c.call(a,e,k)}var f;a=String(a);e.lastIndex=0;e.test(a)&&(a=a.replace(e,function(a){return"\\u"+("0000"+a.charCodeAt(0).toString(16)).slice(-4)}));if(/^[\],:{}\s]*$/.test(a.replace(/\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g,"@").replace(/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,"]").replace(/(?:^|:|,)(?:\s*\[)+/g,"")))return f=
...
1)}this._setStatus("internal_server_error");clearTimeout(this._timeout);clearInterval(this._interval);clearInterval(this._inQto);this._handleEvent("onerror",JSJaCError("500","wait","internal-server-error"));this._connected=!1;this.oDbg.log("Disconnected.",1);this._handleEvent("ondisconnect");return null}if(!a.responseText)return null;try{var g=a.responseText.replace(/<\?xml.+\?>/,"");g.match(/<stream:stream/)&&(g+="</stream:stream>");var k=JSJaCHttpPollingConnection._parseTree("<body>"+g+"</body>");
k&&"parsererror"!=k.tagName||(this.oDbg.log("parsererror",1),(k=JSJaCHttpPollingConnection._parseTree("<stream:stream xmlns:stream='http://etherx.jabber.org/streams'>"+a.responseText))&&"parsererror"!=k.tagName?(this.oDbg.log("stream closed",1),0<k.getElementsByTagName("conflict").length&&this._setStatus("session-terminate-conflict"),clearTimeout(this._timeout),clearInterval(this._interval),clearInterval(this._inQto),this._handleEvent("onerror",JSJaCError("503","cancel","session-terminate")),this._connected=
...
JSJaCJSON.toString=function(a){var c={"\b":"\\b","\t":"\\t","\n":"\\n","\f":"\\f","\r":"\\r",'"':'\\"',"\\":"\\\\"},d={array:function(a){var c=["["],g,k,n,v=a.length,w;for(n=0;n<v;n+=1)if(w=a[n],k=d[typeof w])try{w=k(w),"string"==typeof w&&(g&&(c[c.length]=","),c[c.length]=w,g=!0)}catch(p){}c[c.length]="]";return c.join("")},"boolean":function(a){return String(a)},"null":function(){return"null"},number:function(a){return isFinite(a)?String(a):"null"},object:function(a){if(a){if(a instanceof Array)return d.array(a);
var c=[],g,k,n,v;c.push("{");for(n in a)if(a.hasOwnProperty(n)&&(v=a[n],k=d[typeof v]))try{v=k(v),"string"==typeof v&&(g&&(c[c.length]=","),c.push(d.string(n),":",v),g=!0)}catch(w){}c[c.length]="}";return c.join("")}return"null"},string:function(a){/["\\\x00-\x1f]/.test(a)&&(a=a.replace(/([\x00-\x1f\\"])/g,function(a,d){var e=c[d];if(e)return e;e=d.charCodeAt();return"\\u00"+Math.floor(e/16).toString(16)+(e%16).toString(16)}));return'"'+a+'"'}};switch(typeof a){case "object":return d.object(a);case "array":return d.array(a)}};
...
function binb_sha1(a,c){a[c>>5]|=128<<24-c%32;a[(c+64>>9<<4)+15]=c;for(var d=Array(80),e=1732584193,f=-271733879,g=-1732584194,k=271733878,n=-1009589776,v=0;v<a.length;v+=16){for(var w=e,p=f,B=g,D=k,m=n,x=0;80>x;x++){d[x]=16>x?a[v+x]:bit_rol(d[x-3]^d[x-8]^d[x-14]^d[x-16],1);var y=safe_add(safe_add(bit_rol(e,5),sha1_ft(x,f,g,k)),safe_add(safe_add(n,d[x]),sha1_kt(x))),n=k,k=g,g=bit_rol(f,30),f=e,e=y}e=safe_add(e,w);f=safe_add(f,p);g=safe_add(g,B);k=safe_add(k,D);n=safe_add(n,m)}return[e,f,g,k,n]}
...
function rstr2b64(a){try{b64pad}catch(c){b64pad=""}for(var d="",e=a.length,f=0;f<e;f+=3)for(var g=a.charCodeAt(f)<<16|(f+1<e?a.charCodeAt(f+1)<<8:0)|(f+2<e?a.charCodeAt(f+2):0),k=0;4>k;k++)d=8*f+6*k>8*a.length?d+b64pad:d+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(g>>>6*(3-k)&63);return d}
function arr2b64(a){try{b64pad}catch(c){b64pad=""}for(var d="",e=a.length,f=0;f<e;f+=3)for(var g=a[f]<<16|(f+1<e?a[f+1]<<8:0)|(f+2<e?a[f+2]:0),k=0;4>k;k++)d=8*f+6*k>8*a.length?d+b64pad:d+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(g>>>6*(3-k)&63);return d}
function rstr2any(a,c){var d=c.length,e,f,g,k,n,v=Array(Math.ceil(a.length/2));for(e=0;e<v.length;e++)v[e]=a.charCodeAt(2*e)<<8|a.charCodeAt(2*e+1);var w=Math.ceil(8*a.length/(Math.log(c.length)/Math.log(2))),p=Array(w);for(f=0;f<w;f++){n=[];for(e=k=0;e<v.length;e++)if(k=(k<<16)+v[e],g=Math.floor(k/d),k-=g*d,0<n.length||0<g)n[n.length]=g;p[f]=k;v=n}d="";for(e=p.length-1;0<=e;e--)d+=c.charAt(p[e]);return d}
...
function binl_md5(a,c){a[c>>5]|=128<<c%32;a[(c+64>>>9<<4)+14]=c;for(var d=1732584193,e=-271733879,f=-1732584194,g=271733878,k=0;k<a.length;k+=16)var n=d,v=e,w=f,p=g,d=md5_ff(d,e,f,g,a[k+0],7,-680876936),g=md5_ff(g,d,e,f,a[k+1],12,-389564586),f=md5_ff(f,g,d,e,a[k+2],17,606105819),e=md5_ff(e,f,g,d,a[k+3],22,-1044525330),d=md5_ff(d,e,f,g,a[k+4],7,-176418897),g=md5_ff(g,d,e,f,a[k+5],12,1200080426),f=md5_ff(f,g,d,e,a[k+6],17,-1473231341),e=md5_ff(e,f,g,d,a[k+7],22,-45705983),d=md5_ff(d,e,f,g,a[k+8],7,
1770035416),g=md5_ff(g,d,e,f,a[k+9],12,-1958414417),f=md5_ff(f,g,d,e,a[k+10],17,-42063),e=md5_ff(e,f,g,d,a[k+11],22,-1990404162),d=md5_ff(d,e,f,g,a[k+12],7,1804603682),g=md5_ff(g,d,e,f,a[k+13],12,-40341101),f=md5_ff(f,g,d,e,a[k+14],17,-1502002290),e=md5_ff(e,f,g,d,a[k+15],22,1236535329),d=md5_gg(d,e,f,g,a[k+1],5,-165796510),g=md5_gg(g,d,e,f,a[k+6],9,-1069501632),f=md5_gg(f,g,d,e,a[k+11],14,643717713),e=md5_gg(e,f,g,d,a[k+0],20,-373897302),d=md5_gg(d,e,f,g,a[k+5],5,-701558691),g=md5_gg(g,d,e,f,a[k+
10],9,38016083),f=md5_gg(f,g,d,e,a[k+15],14,-660478335),e=md5_gg(e,f,g,d,a[k+4],20,-405537848),d=md5_gg(d,e,f,g,a[k+9],5,568446438),g=md5_gg(g,d,e,f,a[k+14],9,-1019803690),f=md5_gg(f,g,d,e,a[k+3],14,-187363961),e=md5_gg(e,f,g,d,a[k+8],20,1163531501),d=md5_gg(d,e,f,g,a[k+13],5,-1444681467),g=md5_gg(g,d,e,f,a[k+2],9,-51403784),f=md5_gg(f,g,d,e,a[k+7],14,1735328473),e=md5_gg(e,f,g,d,a[k+12],20,-1926607734),d=md5_hh(d,e,f,g,a[k+5],4,-378558),g=md5_hh(g,d,e,f,a[k+8],11,-2022574463),f=md5_hh(f,g,d,e,a[k+
11],16,1839030562),e=md5_hh(e,f,g,d,a[k+14],23,-35309556),d=md5_hh(d,e,f,g,a[k+1],4,-1530992060),g=md5_hh(g,d,e,f,a[k+4],11,1272893353),f=md5_hh(f,g,d,e,a[k+7],16,-155497632),e=md5_hh(e,f,g,d,a[k+10],23,-1094730640),d=md5_hh(d,e,f,g,a[k+13],4,681279174),g=md5_hh(g,d,e,f,a[k+0],11,-358537222),f=md5_hh(f,g,d,e,a[k+3],16,-722521979),e=md5_hh(e,f,g,d,a[k+6],23,76029189),d=md5_hh(d,e,f,g,a[k+9],4,-640364487),g=md5_hh(g,d,e,f,a[k+12],11,-421815835),f=md5_hh(f,g,d,e,a[k+15],16,530742520),e=md5_hh(e,f,g,
d,a[k+2],23,-995338651),d=md5_ii(d,e,f,g,a[k+0],6,-198630844),g=md5_ii(g,d,e,f,a[k+7],10,1126891415),f=md5_ii(f,g,d,e,a[k+14],15,-1416354905),e=md5_ii(e,f,g,d,a[k+5],21,-57434055),d=md5_ii(d,e,f,g,a[k+12],6,1700485571),g=md5_ii(g,d,e,f,a[k+3],10,-1894986606),f=md5_ii(f,g,d,e,a[k+10],15,-1051523),e=md5_ii(e,f,g,d,a[k+1],21,-2054922799),d=md5_ii(d,e,f,g,a[k+8],6,1873313359),g=md5_ii(g,d,e,f,a[k+15],10,-30611744),f=md5_ii(f,g,d,e,a[k+6],15,-1560198380),e=md5_ii(e,f,g,d,a[k+13],21,1309151649),d=md5_ii(d,
e,f,g,a[k+4],6,-145523070),g=md5_ii(g,d,e,f,a[k+11],10,-1120210379),f=md5_ii(f,g,d,e,a[k+2],15,718787259),e=md5_ii(e,f,g,d,a[k+9],21,-343485551),d=safe_add(d,n),e=safe_add(e,v),f=safe_add(f,w),g=safe_add(g,p);return[d,e,f,g]}function md5_cmn(a,c,d,e,f,g){return safe_add(bit_rol(safe_add(safe_add(c,a),safe_add(e,g)),f),d)}function md5_ff(a,c,d,e,f,g,k){return md5_cmn(c&d|~c&e,a,c,f,g,k)}function md5_gg(a,c,d,e,f,g,k){return md5_cmn(c&e|d&~e,a,c,f,g,k)}
function md5_hh(a,c,d,e,f,g,k){return md5_cmn(c^d^e,a,c,f,g,k)}function md5_ii(a,c,d,e,f,g,k){return md5_cmn(d^(c|~e),a,c,f,g,k)}function safe_add(a,c){var d=(a&65535)+(c&65535);return(a>>16)+(c>>16)+(d>>16)<<16|d&65535}function bit_rol(a,c){return a<<c|a>>>32-c}
...
function(){a.xhrReadyStateChanged()}};XMLHttpRequest.prototype.open=function(d,e,f,g,k){var n=document.createElement("a");n.href=e;n.hostname!=document.domain?(null===this.xdr&&(this.xdr=new a.XDomainRequest),this.isxdr=!0,this.setXDRActive(),this.xdr.open(d,e)):(null===this.xhr&&(this.xhr=new c),this.isxdr=!1,this.setXHRActive(),this.xhr.open(d,e,f,g,k))};XMLHttpRequest.prototype.xdrGetResponseHeader=function(a){return"Content-Type"===a&&""<this.xdr.contentType?this.xdr.contentType:""};XMLHttpRequest.prototype.xdrGetAllResponseHeaders=
...
chat_info:{},content_type:"avatar"==a.contentType?"avatar":"image"==a.contentType?8:4,file_dialog_start_handler:function(){},file_queued_handler:function(c){var e=a.getChatInfo&&a.getChatInfo()||{},f=YYIMChat.getServletPath().FILE_UPLOAD_SERVLET,g,k,n,v=e.to||YYIMChat.getUserNode();YYIMChat.isAnonymous()?(g=YYIMChat.getUserFullJID(),n="anonymous"):(g=YYIMChat.getUserNode(),n=YYIMChat.getToken());k=e.resource&&"anonymous"==e.resource.toLowerCase()?YYIMChat.getJIDUtil().buildUserJID(YYIMChat.getJIDUtil().getID(v),
"ANONYMOUS"):YYIMChat.getJIDUtil().getNode(v);f=f+"?fileName="+encodeURI(c.name,"utf-8")+"&uploadedSize=0&fileSize="+c.size+"&fromUser="+g+"&toUser="+k+"&token="+n+"&muc=1";"avatar"===a.contentType&&(f+="&isAvatar=true");this.settings.chat_info={to:YYIMChat.getJIDUtil().getNode(v),type:e.type?e.type:"chat",resource:e.resource};this.setUploadURL(f)},file_queue_error_handler:function(){a.error&&a.error(arguments)},file_dialog_complete_handler:function(){this.startUpload()},upload_start_handler:function(){},
...
breakPoints:!0,fileSplitSize:10485760,getUploadedSize:null,saveUploadedSize:null,saveInfoLocal:!0,onUploadStart:null,onUploadSuccess:null,onUploadComplete:null,onUploadError:null,onInit:null,onCancel:null,onSelect:null,uploadIdPrefix:"file_upload_",inputId:null,to:null,type:4,chatType:"chat",showProcess:!1,processId:null,resource:null},a),d=function(a,d,g,k,n,v){parseInt(SNSStorage.getLocalVal(g.name));YYIMChat.isAnonymous()?YYIMChat.getUserFullJID():(YYIMChat.getUserNode(),YYIMChat.getToken());c.resource&&
"anonymous"==c.resource.toLowerCase()?YYIMChat.getJIDUtil().buildUserJID(YYIMChat.getJIDUtil().getID(v),"ANONYMOUS"):"groupchat"==c.chatType?YYIMChat.getJIDUtil().buildChatGroupJID(YYIMChat.getJIDUtil().getNode(v)):YYIMChat.getJIDUtil().buildUserJID(YYIMChat.getJIDUtil().getNode(v));encodeURI(g.name,"utf-8");a=YYIMChat.getServletPath().REST_RESOURCE_SERVLET+YYIMChat.getTenancy().ETP_KEY+"/"+YYIMChat.getTenancy().APP_KEY+"/upload?token="+YYIMChat.getToken();n={name:encodeURI(g.name,"utf-8"),mediaType:8===
c.type?1:2,creator:YYIMChat.getUserNode(),receiver:YYIMChat.getJIDUtil().buildUserJID(YYIMChat.getJIDUtil().getNode(v)),size:n,original:1};"groupchat"==c.chatType&&(n.receiver=YYIMChat.getJIDUtil().buildChatGroupJID(YYIMChat.getJIDUtil().getNode(v)));a+="&"+jQuery.param(n);YYIMChat.log("file upload url",2,a);d.open(c.method,a,!0);d.setRequestHeader("X-Requested-With","XMLHttpRequest");a=new FormData;a.append(c.fileObjName,g);if(k)for(key in k)a.append(key,k[key]);d.send(a)};this.each(function(){var a=
jQuery(this),f=jQuery(".uploadify").length+1,g='<span id="'+c.uploadIdPrefix+f+'-queue" class="uploadify-queue"></span>',k=jQuery("#"+c.processId);0>=jQuery("#"+c.uploadIdPrefix+f+"-queue").length&&c.showProcess&&k.append(g);FileUpload.getInstanceByInputId(c.inputId).fileObj={uploadAllowed:!0,fileInput:a,uploadFileList:k.find("#"+c.uploadIdPrefix+f+"-queue"),url:c.uploader,fileFilter:[],uploadOver:!1,filter:function(a){for(var d=[],e=c.fileTypeExts.split(";"),f=0,g=a.length;f<g;f++){var k=a[f];parseInt(FileUpload.formatFileSize(k.size,
!0))>c.fileSizeLimit?alert("\u6587\u4ef6"+k.name+"\u5927\u5c0f\u8d85\u51fa\u9650\u5236\uff01"):"*"==c.fileTypeExts||0<=jQuery.inArray(k.name.split(".").pop().toLowerCase(),e)?d.push(k):alert("\u6587\u4ef6"+k.name+"\u7c7b\u578b\u4e0d\u5141\u8bb8\uff01")}return d},funSelect:function(d){for(var g=0,k=d.length;g<k;g++){var p=d[g];filesIndex+=","+p.index;var B="unknown";p.name&&(B=p.name.substr(p.name.lastIndexOf(".")+1));B=jQuery(c.itemTemplate.replace(/\${fileID}/g,"fileupload_"+f+"_"+p.index).replace(/\${fileTypeIcon}/g,
"res/skin/default/icons/filetype/"+B+".png").replace(/\${fileName}/g,p.name).replace(/\${fileSize}/g,FileUpload.formatFileSize(p.size)).replace(/\${instanceID}/g,a.attr("id")).replace(/\${continueUpload}/g,"continueUpload_"+f+"_"+p.index));c.auto&&B.find(".uploadbtn").remove();var D=0,m="0KB",x="0%";c.breakPoints&&(x=this.funGetUploadedSize(p),D=x/p.size*100+"%",m=FileUpload.formatFileSize(x),x=(x/p.size*100).toFixed(2)+"%",B.find(".uploadify-progress-bar").css("width",D));this.uploadFileList.append(B);
c.showUploadedSize&&(D='<span class="progressnum"><span id="isUploadingFileSize_'+f+"_"+p.index+'" class="uploadedsize">'+m+'</span>/<span class="totalsize">${fileSize}</span></span>'.replace(/\${fileSize}/g,FileUpload.formatFileSize(p.size)),B.find(".uploadify-progress").after(D));c.showUploadedPercent&&(D='<span class="up_percent" style="display:none">'+x+"</span>",B.find(".uploadify-progress").after(D));c.onSelect&&c.onSelect(d);c.auto?this.funUploadFile(p):B.find(".uploadbtn").click(function(a){return function(){FileUpload.getInstanceByInputId(c.inputId).fileObj.funUploadFile(a)}}(p));
B.find(".delfilebtn").click(function(a){return function(){FileUpload.getInstanceByInputId(c.inputId).fileObj.funDeleteFile(a)}}(p));B.find("#btnstop").click(function(a){return function(){deletefilesIndex+=","+a.index}}(p));B.find("#continueUpload_"+f+"_"+p.index).click(function(a){var d=a.index;return function(){if(0<deletefilesIndex.length&&-1<deletefilesIndex.indexOf(","+d)){for(var a=deletefilesIndex.split(","),f="",e=0;e<a.length;e++)a[e]!=d&&""!=a[e]&&(f+=","+a[e]);deletefilesIndex=f}(a=FileUpload.getFile(d,
FileUpload.getInstanceByInputId(c.inputId).fileObj.fileFilter))&&FileUpload.getInstanceByInputId(c.inputId).fileObj.funUploadFile(a)}}(p))}},onProgress:function(a,d,e){a=k.find("#fileupload_"+f+"_"+a.index+" .uploadify-progress").attr("lastLoaded")||0;d<a&&(a=0);d-=parseInt(a);a=(d/e).toFixed(4);a=1<a?1:a;c.onUploadProgress&&c.onUploadProgress({percent:a,loaded:d,total:e})},funGetProgressWidth:function(a){},funGetUploadedSize:function(a){if(c.getUploadedSize)return c.getUploadedSize(a);if(c.saveInfoLocal)return parseInt(SNSStorage.getLocalVal(a.name))||
0},funSaveUploadedSize:function(a,d,e){c.saveUploadedSize?c.saveUploadedSize(a,d):c.saveInfoLocal&&!e&&SNSStorage.setLocal(a.name,d)},funSendFile:function(a){a=a.files;a=this.filter(a);for(var c=0,d=a.length;c<d;c++)this.fileFilter.push(a[c]);this.funDealFiles(a);return this},funDealFiles:function(a){for(var c=k.find(".uploadify-queue .uploadify-queue-item").length,d=0,e=a.length;d<e;d++)a[d].index=++c,a[d].id="fileupload_"+f+"_"+a[d].index;this.funSelect(a);return this},funDeleteFile:function(a){c.breakPoints&&
(deletefilesIndex+=","+a.index);k.find("#fileupload_"+f+"_"+a.index).fadeOut();FileUpload.getInstanceByInputId(c.inputId).fileObj.fileInput.val("");c.onCancel&&c.onCancel(a);var d=YYIMChat.getServletPath().FILE_DELETE_SERVLET,e={fileName:a.name,toUser:c.to,fromUser:YYIMChat.getUserNode(),token:YYIMChat.getToken(),muc:1};$.ajax({url:d,async:!1,type:"POST",data:e,dataType:"text",success:function(c){"success"==c&&(SNSStorage.removeLocal(a.name),isDelete=!0)},error:function(){SNSStorage.removeLocal(a.name);
isDelete=!0}});return this},funUploadFile:function(a){var e=!1,g=a,p=k.find("#fileupload_"+f+"_"+a.index),B=function(){FileUpload.getInstanceByInputId(c.inputId).fileObj.uploadOver&&(p.find(".uploadify-progress-bar").css("width","100%"),c.showUploadedSize&&p.find(".uploadedsize").text(p.find(".totalsize").text()),c.showUploadedPercent&&p.find(".up_percent").text("100%"))};try{e=new XMLHttpRequest}catch(D){e=ActiveXobject("Msxml12.XMLHTTP")}if("undefined"==e)alert("\u6d4f\u89c8\u5668\u7248\u672c\u4e0d\u652f\u6301\uff0c\u8bf7\u66f4\u65b0\u7248\u672c");
else{31457280>=g.size||-1<g.type.indexOf("image/")?c.breakPoints=!1:c.breakPoints=!0;if(c.breakPoints){var m=a.name,x=a.id,y=a.index,u=a.size,r=parseInt(this.funGetUploadedSize(g));if(browserSys.firefox){var C=browserSys.firefox.split(".");a=6<C[0]&&15>C[0]?g.mozSlice(r,r+c.fileSplitSize):g.slice(r,r+c.fileSplitSize)}else browserSys.chrome?(C=browserSys.chrome.split("."),a=10<C[0]&&21>C[0]?g.webkitSlice(r,r+c.fileSplitSize):g.slice(r,r+c.fileSplitSize)):a=g.slice(r,r+c.fileSplitSize);a.name=m;a.id=
x;a.index=y}e.upload&&!1!==r&&e.upload.addEventListener("progress",function(d){FileUpload.getInstanceByInputId(c.inputId).fileObj.onProgress(a,d.loaded,g.size)},!1);var G=c.to;g.userJid=G;e.onreadystatechange=function(p){if(4==e.readyState){FileUpload.getInstanceByInputId(c.inputId).fileObj.uploadOver=!0;if(200==e.status){p=JSON.parse(e.responseText);"success"==p.status&&(setTimeout(function(){k.find("#fileupload_"+f+"_"+g.index).fadeOut()},100),SNSStorage.removeLocal(a.name));var s=g.index;c.breakPoints?
(r+=c.fileSplitSize,"success"==p.status||isDelete?(FileUpload.getInstanceByInputId(c.inputId).fileObj.funSaveUploadedSize(g,r,!0),isDelete=!1):FileUpload.getInstanceByInputId(c.inputId).fileObj.funSaveUploadedSize(g,r,!1),-1<deletefilesIndex.indexOf(s)&&SNSStorage.removeLocal(g.name),r<u?(FileUpload.getInstanceByInputId(c.inputId).fileObj.uploadOver=!1,-1<filesIndex.indexOf(","+s)&&-1==deletefilesIndex.indexOf(s)&&(browserSys.firefox?(s=browserSys.firefox.split("."),a=6<s[0]&&15>s[0]?g.mozSlice(r,
r+c.fileSplitSize):g.slice(r,r+c.fileSplitSize)):browserSys.chrome?(s=browserSys.chrome.split("."),a=10<s[0]&&21>s[0]?g.webkitSlice(r,r+c.fileSplitSize):g.slice(r,r+c.fileSplitSize)):a=g.slice(r,r+c.fileSplitSize),a.name=m,a.id=x,a.index=y,a.size=u,d(FileUpload.getInstanceByInputId(c.inputId).fileObj.url,e,a,c.formData,g.size,G))):B()):B();FileUpload.getInstanceByInputId(c.inputId).fileObj.uploadOver&&(c.type==UPLOAD_AVATAR?c.onUploadSuccess&&c.onUploadSuccess(p):(p={id:Math.uuid(),body:{content:new SNSFile(a.name,
p.attachId,a.size),contentType:c.type,dateline:(new Date).getTime()},to:c.to,type:c.chatType,success:function(a){var d=Object.clone(a);d.to=YYIMChat.getJIDUtil().getID(a.to);c.onUploadSuccess&&c.onUploadSuccess(d)}},c.resource&&(p.resource=c.resource),YYIMChat.sendMessage(p)),setTimeout(function(){k.find("#fileupload_"+f+"_"+g.index).fadeOut()},c.removeTimeout))}else FileUpload.getInstanceByInputId(c.inputId).fileObj.uploadOver&&c.onUploadError&&c.onUploadError(g,e.responseText),setTimeout(function(){k.find("#fileupload_"+
f+"_"+g.index).fadeOut()},100),SNSStorage.removeLocal(a.name);FileUpload.getInstanceByInputId(c.inputId).fileObj.uploadOver&&(c.onUploadComplete&&c.onUploadComplete(g,e.responseText),FileUpload.getInstanceByInputId(c.inputId).fileObj.fileInput.val(""))}};c.onUploadStart&&c.onUploadStart();FileUpload.getInstanceByInputId(c.inputId).fileObj.uploadAllowed=!0;d(this.url,e,a,c.formData,g.size,G)}}};c.onInit&&c.onInit()})}
...
h.getInstance().getUserBareJID();if(a){if(a instanceof JSJaCJID)return a.getBareJID()==c?a.toString():a.getBareJID();if("string"==typeof a)return a=new JSJaCJID(a),a.getBareJID()==c?a.toString():a.getBareJID();if(a.jid&&a.jid instanceof JSJaCJID)return a=a.jid,a.getBareJID()==c?a.toString():a.getBareJID()}throw new JSJaCJIDInvalidException("invalid jid: "+a);},getID:function(a){var c,d,e;return YYIMCommonUtil.isStringAndNotEmpty(a)?(c=h.getInstance().getAppkey(),e=a.indexOf("@"),-1!=e?(d=a.substring(0,
e),0<d.indexOf(c)?d.replace(c,""):d):0<a.indexOf(c)?a.replace(c,""):a):null},getNode:function(a){if(YYIMCommonUtil.isStringAndNotEmpty(a)){var c=h.getInstance().getAppkey(),d=a;if(-1<d.indexOf("@")){if(0===d.indexOf("@"))throw'"'+a+'" Can\'t start with  "@"!';d=d.substring(0,d.indexOf("@"))}if(-1<d.indexOf(".")){if(0===d.indexOf("."))throw'"'+a+'" Can\'t start with "."!';d=d.substring(0,d.indexOf("."))}return d?d+c:d}throw'"'+a+"\" Can't be Number Or Empty!";},getResource:function(a){return YYIMCommonUtil.isStringAndNotEmpty(a)?
...
-1!=a.indexOf("@")?a:a+"@"+m.DOMAIN.PUBACCOUNT:null}},g="im.yyuap.com",k="stellar.yyuap.com",n=5227,v=7075,w="http://im.yyuap.com/",p="https://im.yyuap.com/";jQuery.support.cors=!0;var B;-1<navigator.userAgent.indexOf("Safari")&&1>navigator.userAgent.indexOf("Chrome")?B=!1:(window.WebSocket=window.WebSocket||window.MozWebSocket,B=window.WebSocket?!0:!1);var D;D=window.localStorage?!0:!1;var m={RESOURCE:"web-v2.6",IS_ANONYMOUS:!0,MULTI_TENANCY:{ENABLE:!0,ETP_KEY:"etp",APP_KEY:"app",SEPARATOR:"."},
RECEIPTSPACKET_AUTO:!1,SENDINTERVAL:30,RECENTCONTACTSDAY:7,RECENTCONTACTSNUM:20,RECENTCONTACTSMODE:{CONTACTNUM:{NAME:"number",DEFAULT:7},CONTACTDAYS:{NAME:"days",DEFAULT:20}},TIMECORRECTION:{TIMES:3,RESIDUAL:50,RESULT:0},MULTIPARTYCALL:{ADDRESS:"http://dudu.yonyoutelecom.cn/httpIntf/createConference.do",ACCOUNT:"",KEY:"",PHONESMAXLENGTH:200,PARTYMAXLENGTH:12},SUPPORT:{isWebSocketSupport:B,isLocalConnectionSupport:D},CONNECTION:{TIMERVAL:2E3,WAIT:300,SECURE:!1,ALLOW_PLAIN:!0,ENABLE_WEBSOCKET:!0,ENABLE_LOCAL_CONNECTION:!0,
USE_HTTPS:!1,SERVER_NAME:g,HTTP_BASE:k,HTTP_BIND_PORT:v,WS_PORT:n},PING:{INTERVAL:3E4,DURATION:3E4,TIMEOUT:3E4},SERVLET:{FILE_UPLOAD_SERVLET:w+"sysadmin/fileUpload",FILE_DOWNLOAD_SERVLET:w+"sysadmin/download",FILE_DELETE_SERVLET:w+"sysadmin/cancel",AVATAR_SERVLET:w+"sysadmin/avatar",REST_RESOURCE_SERVLET:w+"sysadmin/rest/resource/",REST_HISTORY_SERVLET:w+"sysadmin/rest/history/",REST_VERSION_SERVLET:w+"sysadmin/rest/version/",REST_USER_SERVLET:w+"sysadmin/rest/user/",REST_UPLOAD_SERVLET:w+"im_upload/rest/resource/",
REST_DOWNLOAD_SERVLET:w+"im_download/rest/resource/",REST_TRANSFORM_SERVLET:w+"im_download/rest/transform/resource/",REST_USER_SERVLET_SAFE:p+"sysadmin/rest/user/",REST_SYSTEM_SERVLET_SAFE:p+"sysadmin/rest/system/"},DOMAIN:{CHATROOM:"conference."+g,SEARCH:"search."+g,PUBACCOUNT:"pubaccount."+g},MESSAGE:{SEND_TIMEOUT:3E4,MAX_CHARACHER:1E3,REQUEST_RECEIPTS:!0},LOG:{ENABLE:!0,FILTER_LEVEL:3},BROWSER:function(){var a=navigator.userAgent.toLowerCase();return{version:(a.match(/.+(?:rv|it|ra|ie)[\/: ]([\d.]+)/)||
...
this.CONNECTION.ENABLE_WEBSOCKET},useLocalConnection:function(){return this.SUPPORT.isLocalConnectionSupport&&this.CONNECTION.ENABLE_LOCAL_CONNECTION},getConnectionArgObj:function(){var a={domain:this.CONNECTION.SERVER_NAME,resource:this.RESOURCE,allow_plain:this.CONNECTION.ALLOW_PLAIN,secure:this.CONNECTION.SECURE,register:!1};this.IS_ANONYMOUS&&(a.authtype="saslanon");return a}},x={CHAT:"chat",AWAY:"away",XA:"xa",DND:"dnd",UNAVAILABLE:"unavailable"},y={MIXED:"mixed",SIMPLE:"simple",TEXT:2,FILE:4,
IMAGE:8,SYSTEM:16,PUBLIC:32,AUDO:64,LOCATION:128,SHARE:256,WHITEBOARD:1024,NETMEETING:2048},u=function(){var a=function(){return{getVCard:function(a){var c={type:"get"};YYIMCommonUtil.isStringAndNotEmpty(a.jid)?c.to=a.jid:null;d.getInstance().send(new JumpPacket(c,OPCODE.VCARD.SEND),function(a,c){c.complete&&c.complete();var d=a.vcard||{};d.id=d.userId=f.getID(d.username);a.enableFields&&(d.enableFields=a.enableFields);c.success&&c.success(d)},a)},setVCard:function(a){d.getInstance().send(new JumpPacket({type:"set",
vcard:a.vcard},OPCODE.VCARD.SEND),function(a,c){c.complete&&c.complete();c.success&&c.success()},a)},setVCardTag:function(a){var c;c=a.id&&a.id!==h.getInstance().getUserID()?m.SERVLET.REST_USER_SERVLET_SAFE+m.MULTI_TENANCY.ETP_KEY+"/"+m.MULTI_TENANCY.APP_KEY+"/"+h.getInstance().getUserID()+"/"+a.id+"/roster/tag?token="+h.getInstance().getToken():m.SERVLET.REST_USER_SERVLET+m.MULTI_TENANCY.ETP_KEY+"/"+m.MULTI_TENANCY.APP_KEY+"/"+h.getInstance().getUserID()+"/vcard/tag?token="+h.getInstance().getToken();
jQuery.ajax({url:c,type:"post",data:JSON.stringify({tag:a.tag}),dataType:"json",cache:!1,processData:!1,contentType:"application/json",success:function(c){a.success&&a.success(a.id)},error:function(){a.error&&a.error()}})},getVCards:function(a){d.getInstance().send(new JumpPacket({type:"roster"},OPCODE.VCARDS.SEND),function(a,c){var d=a.vcards||[];vcards=[];for(i=d.length;i--;){var l=d[i];l.userId=f.getID(l.username);vcards.push(l)}c.complete&&c.complete();c.success&&c.success(vcards)},a)},getRostersPresence:function(a){jQuery.ajax({url:m.SERVLET.REST_USER_SERVLET+
m.MULTI_TENANCY.ETP_KEY+"/"+m.MULTI_TENANCY.APP_KEY+"/"+h.getInstance().getUserID()+"/presence/detail?token="+h.getInstance().getToken()+"&username="+a.username,type:"get",dataType:"json",cache:!1,success:function(c){a.success&&a.success(c)},error:function(){a.error&&a.error()},complete:function(){a.complete&&a.complete()}})},getRecentContacts:function(a){var c={token:h.getInstance().getToken(),username:h.getInstance().getUserID()},d=m.SERVLET.REST_USER_SERVLET+"recentcontact/"+m.MULTI_TENANCY.ETP_KEY+
"/"+m.MULTI_TENANCY.APP_KEY;a=a||{};a.mode=a.mode||m.RECENTCONTACTSMODE.CONTACTDAYS.NAME;if(a.mode===m.RECENTCONTACTSMODE.CONTACTNUM.NAME)d+="/recent/contacts",c.contactsCount="number"==typeof a.contactsCount&&0<a.contactsCount?a.contactsCount:m.RECENTCONTACTSMODE.CONTACTNUM.DEFAULT;else{var d=d+"/recentContacts",l=(new Date).getTime();c.startDate=l-864E5*("number"==typeof a.contactsDays&&0<a.contactsDays?a.contactsDays:m.RECENTCONTACTSMODE.CONTACTDAYS.DEFAULT);c.endDate=l}jQuery.ajax({url:d,type:"get",
dataType:"json",data:c,cache:!1,success:function(c){var d=[],l;for(l in c)c[l].username&&d.push({id:f.getID(c[l].username),dateline:c[l].lastContactDate});d=d.sort(YYIMUtil.array.comparisonAsc("dateline"));a.success&&a.success(d)},error:function(){a.error&&a.error()},complete:function(){a.complete&&a.complete()}})}}}(),c=function(){return{getRosterItems:function(a){var c=new JumpPacket({},OPCODE.ROSTER_LIST.SEND);d.getInstance().send(c,function(a,c){if(c){c.complete&&c.complete();for(var d=a.items||
[],l=[],e=d.length||0,g={};e--;){var t=d[e],k=t.jid,t={id:f.getID(k),resource:f.getResource(k),ask:t.ask,recv:t.recv,name:t.name,photo:t.photo,subscription:t.subscription,group:t.groups,tag:t.tag};f.getDomain(k)!==m.DOMAIN.PUBACCOUNT&&(l.push(t),g[t.id]||"none"!==t.subscription||1!==t.recv||(g[t.id]=t))}for(var L in g)if(g[L].id)h.getInstance().onSubscribe({from:g[L].id,type:"subscribe"});c.success&&c.success(JSON.stringify(l))}},a)},deleteRosterItem:function(a){var c={type:"set",ns:NS_ROSTER,item:{jid:a.jid,
subscription:"remove"}};d.getInstance().send(new JumpPacket(c,OPCODE.UPDATE_ROSTER.SEND),function(a,c){c.complete&&c.complete();c.success&&c.success(f.getID(c.jid))},a)},queryRosterItem:function(a){var c={start:YYIMCommonUtil.isNumber(a.start)?a.start:0,size:YYIMCommonUtil.isNumber(a.size)?a.size:20,fields:["Username","Name"],search:a.keyword};d.getInstance().send(new JumpPacket(c,OPCODE.QUERY_USER.SEND),function(a,c){for(var d=a.items||[],l=[],e=d.length;e--;){var g=d[e],t=g.jid;t!==h.getInstance().getUserBareJID()&&
l.push({id:f.getID(t),name:YYIMCommonUtil.isStringAndNotEmpty(g.name)?g.name:f.getID(t),photo:g.photo,email:g.email})}c.complete&&c.complete();c.success&&c.success({start:a.start,total:a.total,items:l})},a)},updateRosterItem:function(a){for(var c=a.roster,l={item:{jid:c.jid,name:c.name,groups:[]}},e=(c=c.groups)?c.length:0;e--&&YYIMCommonUtil.isStringAndNotEmpty(c[e]);)l.item.groups=l.item.groups.concat(c[e]);d.getInstance().send(new JumpPacket(l,OPCODE.UPDATE_ROSTER.SEND),function(a,c){c.complete&&
c.complete();400===a.code?c.error&&c.error(a):(a.to=f.getID(a.to),c.success&&c.success(a))},a)}}}(),e=function(){function a(c){if(c){for(var d=c.members.length,l=[];d--;){var e=c.members[d];e.id=f.getID(e.jid);l.push(e)}return{id:f.getID(c.from),name:c.naturalLanguageName||c.name,photo:c.photo,numberOfMembers:c.numberOfMembers,superLarge:c.superLarge,collected:c.collected,type:c.type,creationdate:c.creationdate,creater:f.getID(c.operator),members:l,owners:c.owners,tag:c.tag}}}function c(a){if(a){for(var d=
a.memberItems.length,l=[];d--;){var e=a.memberItems[d];e.id=f.getID(e.jid);l.push(e)}return{id:f.getID(a.from),members:l}}}return{queryChatGroup:function(a){var c={start:YYIMCommonUtil.isNumber(a.start)?a.start:0,size:YYIMCommonUtil.isNumber(a.size)?a.size:20,search:a.keyword};d.getInstance().send(new JumpPacket(c,OPCODE.QUERY_CHATGROUP.SEND),function(a,c){for(var d=a.items||[],l=[],e=d.length;e--;){var g=d[e],t=g.jid;l.push({id:f.getID(t),name:YYIMCommonUtil.isStringAndNotEmpty(g.name)?g.name:f.getID(t)})}c.complete&&
c.complete();c.success&&c.success({start:a.start,total:a.total,items:l})},a)},configChatGroup:function(a){var c={to:a.jid,roomname:a.name,roomdesc:a.desc,persistent:1,owners:[h.getInstance().getUserBareJID()],etp:m.MULTI_TENANCY.ETP_KEY,app:m.MULTI_TENANCY.APP_KEY};YYIMCommonUtil.isStringAndNotEmpty(a.photo)&&(c.photo=a.photo);d.getInstance().send(new JumpPacket(c,OPCODE.CONFIG_CHATGROUP.SEND),function(a,c){c.complete&&c.complete();c.success&&c.success()},a)},getChatGroups:function(c){jQuery.ajax({url:m.SERVLET.REST_USER_SERVLET+
m.MULTI_TENANCY.ETP_KEY+"/"+m.MULTI_TENANCY.APP_KEY+"/rooms?token="+h.getInstance().getToken()+"&username="+h.getInstance().getUserID(),type:"get",dataType:"json",cache:!1,success:function(d){d=d.items||[];for(var l=[],e=d.length||0;e--;){var f=d[e];f.from=f.jid;(f=a(f))&&l.push(f)}c.success&&c.success(JSON.stringify(l))},error:function(){c.error&&c.error()},complete:function(){c.complete&&c.complete()}})},getChatGroupInfo:function(a){var c={to:a.jid,type:"get",ns:NS_DISCO_INFO};d.getInstance().send(new JumpPacket(c,
OPCODE.CHATGROUP_INFO.SEND),function(a,c){c.complete&&c.complete();var d=a.roomname?a.roomname:f.getID(c.jid),l=a.description;c.success&&c.success({name:d,desc:l})},a)},createChatGroup:function(c){var l={id:c.id,naturalLanguageName:c.name,from:h.getInstance().getUserBareJID(),invitees:c.members};d.getInstance().send(new JumpPacket(l,OPCODE.CREATE_GROUP.SEND),function(c,d){d.complete&&d.complete();d.success&&d.success(a(c))},c)},inviteGroupMember:function(c){var l={id:c.id,to:c.to,from:h.getInstance().getUserBareJID(),
invitees:c.members};d.getInstance().send(new JumpPacket(l,OPCODE.INVITE_GROUP_MEMBER.SEND),function(c,d){d.complete&&d.complete();d.success&&d.success(a(c))},c)},modifyChatGroupInfo:function(c){var l={id:c.id,naturalLanguageName:c.name,from:h.getInstance().getUserBareJID(),to:c.to};d.getInstance().send(new JumpPacket(l,OPCODE.MODIFY_GROUP_INFO.SEND),function(c,d){d.complete&&d.complete();d.success&&d.success(a(c))},c)},kickGroupMember:function(c){var l={id:c.id,member:c.member,from:h.getInstance().getUserBareJID(),
to:c.to};d.getInstance().send(new JumpPacket(l,OPCODE.KICK_GROUP_MEMBER.SEND),function(c,d){d.complete&&d.complete();d.success&&d.success(a(c))},c)},exitChatGroup:function(a){var c={id:a.id,from:h.getInstance().getUserBareJID(),to:a.to};d.getInstance().send(new JumpPacket(c,OPCODE.EXIT_GROUP.SEND),function(a,c){c.complete&&c.complete();c.success&&c.success({from:f.getID(a.from),id:a.id,to:f.getID(a.to)})},a)},handleChatGroup:a,transferChatGroupOwner:c,collectChatGroup:function(a){var c={id:a.id,from:h.getInstance().getUserBareJID(),
to:a.to,type:a.type};d.getInstance().send(new JumpPacket(c,OPCODE.COLLECT_GROUP.SEND),function(a,c){c.complete&&c.complete();c.success&&c.success({from:f.getID(c.to),id:a.id,to:h.getInstance().getUserID(),type:c.type,code:a.code,message:a.message})},a)},transferChatGroup:function(a){var l={id:a.id,to:a.to,from:h.getInstance().getUserBareJID(),newOwner:a.newOwner};d.getInstance().send(new JumpPacket(l,OPCODE.TRANSFER_GROUP.SEND),function(a,d){d.complete&&d.complete();d.success&&d.success(c(a))},a)},
dismissChatGroup:function(a){var c={id:a.id,to:a.to,from:h.getInstance().getUserBareJID()};d.getInstance().send(new JumpPacket(c,OPCODE.DISMISS_GROUP.SEND),function(a,c){c.complete&&c.complete();c.success&&c.success({id:a.id,from:f.getID(a.from),to:f.getID(a.to)})},a)},getGroupSharedFiles:function(a){var c={token:h.getInstance().getToken(),username:h.getInstance().getUserID(),mucId:a.id,start:parseInt(a.start||0),size:parseInt(a.size||20)},d=m.SERVLET.REST_USER_SERVLET+"sharefiles/"+m.MULTI_TENANCY.ETP_KEY+
"/"+m.MULTI_TENANCY.APP_KEY+"/muc",d=d+("?"+jQuery.param(c));jQuery.ajax({url:d,type:"get",dataType:"json",cache:!1,success:function(c){c=c.list;for(var d=[],l=c.length;l--;){var e=c[l];e.creator=f.getID(e.creator);d.push(e)}a.success&&a.success(d)},error:function(){a.error&&a.error()},complete:function(){a.complete&&a.complete()}})}}}(),g=function(){return{getGroupMembers:function(a){d.getInstance().send(new JumpPacket({type:"get",ns:NS_DISCO_ITEMS,to:a.jid},OPCODE.CHATGROUP_MEMBER_LIST.SEND),function(a,
c){if(c){c.complete&&c.complete();var d=a.items;if(0!==(d&&d.length||0)){for(var l=[],e=-1,g=d.length;++e<g;){var t=d[e];l.push({id:f.getID(t.jid),name:t.name,photo:t.photo,affiliation:t.affiliation})}c.success&&c.success(JSON.stringify(l))}}},a)}}}(),k=function(){return{getPubAccountItems:function(a){var c=new JumpPacket({type:"get",ns:NS_PUBACCOUNT,to:m.DOMAIN.PUBACCOUNT},OPCODE.PUBACCOUNT_LIST.SEND);d.getInstance().send(c,function(a,c){if(c){c.complete&&c.complete();for(var d=a.items||[],l=d.length||
0;l--;)d[l].id=f.getID(d[l].jid);c.success&&c.success(JSON.stringify(d))}},a)},queryPubaccount:function(a){var c={start:YYIMCommonUtil.isNumber(a.start)?a.start:0,size:YYIMCommonUtil.isNumber(a.size)?a.size:20,fields:["Accountname","Name"],search:a.keyword};d.getInstance().send(new JumpPacket(c,OPCODE.QUERY_PUBACCOUNT.SEND),function(a,c){for(var d=a.items||[],l=[],e=d.length;e--;){var g=d[e],t=g.jid;l.push({id:f.getID(t),name:YYIMCommonUtil.isStringAndNotEmpty(g.name)?g.name:f.getID(t),type:g.type})}c.complete&&
c.complete();c.success&&c.success({start:a.start,total:a.total,items:l})},a)}}}(),n=function(){return{fullSyncRoster:function(a){d.getInstance().send(new JumpPacket({submits:a},OPCODE.FULL_SYNC_ROSTER.SEND))},deltaSyncRoster:function(a,c){var l={};0<a.length&&(l.removes=a);0<c.length&&(l.sets=c);(0<a.length||0<c.length)&&d.getInstance().send(new JumpPacket(l,OPCODE.DELTA_SYNC_ROSTER.SEND))},fullSyncChatGroup:function(a){d.getInstance().send(new JumpPacket({submits:a},OPCODE.FULL_SYNC_CHATGROUP.SEND))},
deltaSyncChatGroup:function(a,c){var l={};0<a.length&&(l.removes=a);0<c.length&&(l.sets=c);(0<a.length||0<c.length)&&d.getInstance().send(new JumpPacket(l,OPCODE.DELTA_SYNC_CHATGROUP.SEND))}}}();return{monitor:function(){var a=d.getInstance();a.registerHandler(OPCODE.UPDATE_ROSTER.KEY,function(a){var c=a.item;a=f.getID(a.item.jid);"both"===c.subscription?(F.log("update or add: "+JSON.stringify(c)),c.id=a,h.getInstance().onRosterUpdateded(c)):"none"===c.subscription&&(F.log("delete: "+JSON.stringify(c)),
h.getInstance().onRosterDeleted(a))});a.registerHandler(OPCODE.ON_GROUP_UPDATE.KEY,function(a){if(a=e.handleChatGroup(a))h.getInstance().onGroupUpdate(a)});a.registerHandler(OPCODE.ON_GROUP_TRANSFER.KEY,function(a){if(a=e.transferChatGroupOwner(a))h.getInstance().onTransferGroupOwner(a)});a.registerHandler(OPCODE.KICKED_GROUP.KEY,function(a){a={id:a.id,from:f.getID(a.from),to:f.getID(a.to)};h.getInstance().onKickedOutGroup(a)});a.registerHandler(OPCODE.PUBACCOUNT_LIST.KEY,function(a){a=a.items;if(0!==
(a&&a.length||0)){for(var c=[],d=a.length;d--;){var l=a[d],e=l.jid,l={id:f.getID(e),name:YYIMCommonUtil.isStringAndNotEmpty(l.name)?l.name:f.getID(e),type:l.type};c.push(l)}h.getInstance().onPubaccountUpdate(c)}})},getVCard:a.getVCard,setVCard:a.setVCard,setVCardTag:a.setVCardTag,getVCards:a.getVCards,getRostersPresence:a.getRostersPresence,getRecentContacts:a.getRecentContacts,getRosterItems:c.getRosterItems,deleteRosterItem:c.deleteRosterItem,queryRosterItem:c.queryRosterItem,updateRosterItem:c.updateRosterItem,
queryChatGroup:e.queryChatGroup,configChatGroup:e.configChatGroup,getChatGroups:e.getChatGroups,getChatGroupInfo:e.getChatGroupInfo,createChatGroup:e.createChatGroup,inviteGroupMember:e.inviteGroupMember,modifyChatGroupInfo:e.modifyChatGroupInfo,kickGroupMember:e.kickGroupMember,exitChatGroup:e.exitChatGroup,collectChatGroup:e.collectChatGroup,transferChatGroup:e.transferChatGroup,dismissChatGroup:e.dismissChatGroup,getGroupSharedFiles:e.getGroupSharedFiles,getGroupMembers:g.getGroupMembers,getPubAccountItems:k.getPubAccountItems,
queryPubaccount:k.queryPubaccount,fullSyncRoster:n.fullSyncRoster,deltaSyncRoster:n.deltaSyncRoster,fullSyncChatGroup:n.fullSyncChatGroup,deltaSyncChatGroup:n.deltaSyncChatGroup}}(),r=function(){function a(d,l){if(!0!==r.get(d.id)&&(r.add(d.id,!0),d.from!==h.getInstance().getUserFullJID())){var g;try{g=JSON.parse(d.content)}catch(k){g=d.content}var K={content:g.content,contentType:d.contentType,dateline:d.dateline,atuser:g.atuser,extend:g.extend},q="groupchat"!=l?f.getID(d.from):{room:f.getID(d.from),
roster:f.getID(f.getResource(d.from))},q={id:d.id,type:l,from:q,data:K};"chat"==l?(q.resource=f.getResource(d.from),q.to=f.getID(d.receiver||d.to)):q.to=h.getInstance().getUserID();if(!0===d.receipts){var n={to:d.from,id:d.id};!0===m.RECEIPTSPACKET_AUTO?(c(n),e(n)):K.receipt=n}if(K.contentType)switch(K.contentType){case y.TEXT:g.style&&(q.data.style=g.style);try{h.getInstance().onTextMessage(q)}catch(p){YYIMChat.log("textMessHandleError:",0,q)}break;case y.IMAGE:q.data&&q.data.content&&q.data.content.path&&
(q.data.content.attachId=q.data.content.path,q.data.content.path=YYIMChat.getFileUrl(q.data.content.path));try{h.getInstance().onPictureMessage(q)}catch(s){YYIMChat.log("imageMessHandleError:",0,q)}break;case y.FILE:q.data&&q.data.content&&q.data.content.path&&(q.data.content.attachId=q.data.content.path,q.data.content.path=YYIMChat.getFileUrl(q.data.content.path));try{h.getInstance().onFileMessage(q)}catch(u){YYIMChat.log("fileMessHandleError:",0,q)}break;case y.SHARE:try{h.getInstance().onShareMessage(q)}catch(v){YYIMChat.log("shareMessHandleError:",
0,q)}break;case y.SYSTEM:q.data.content=g;q.data&&q.data.content&&q.data.content.path&&(q.data.content.attachId=q.data.content.path,q.data.content.path=YYIMChat.getFileUrl(q.data.content.path));try{h.getInstance().onSystemMessage(q)}catch(w){YYIMChat.log("systemMessHandleError:",0,q)}break;case y.PUBLIC:!g.content&&g.length&&(q.data.content=g);try{h.getInstance().onPublicMessage(q)}catch(x){YYIMChat.log("publicMessHandleError:",0,q)}break;case y.AUDO:q.data&&q.data.content&&q.data.content.path&&(q.data.content.attachId=
q.data.content.path,q.data.content.path=YYIMChat.getFileUrl(q.data.content.path));try{h.getInstance().onAudoMessage(q)}catch(z){YYIMChat.log("AudoMessHandleError:",0,q)}break;case y.LOCATION:q.data&&q.data.content&&q.data.content.path&&(q.data.content.attachId=q.data.content.path,q.data.content.path=YYIMChat.getFileUrl(q.data.content.path));try{h.getInstance().onLocationMessage(q)}catch(N){YYIMChat.log("LocationMessHandleError:",0,q)}break;case y.WHITEBOARD:try{h.getInstance().onWhiteBoardMessage(q)}catch(A){YYIMChat.log("WhiteBoardMessHandleError:",
0,q)}break;default:YYIMChat.log("unhandlePacketError:",0,q)}}}function c(a){a=new JumpPacket({to:f.buildUserJID(f.getNode(a.to),h.getInstance().getUserResource()),dateline:(new Date).getTime(),id:a.id},OPCODE.RECEIPTS.SEND);d.getInstance().send(a)}function e(a){a=new JumpPacket({to:f.buildUserJID(f.getNode(a.to),h.getInstance().getUserResource()),dateline:(new Date).getTime(),id:a.id,state:2},OPCODE.RECEIPTS.SEND);d.getInstance().send(a)}function g(a,c){if(m.RECEIPTSPACKET_AUTO){var d=m.SERVLET.REST_VERSION_SERVLET+
m.MULTI_TENANCY.ETP_KEY+"/"+m.MULTI_TENANCY.APP_KEY+"/"+c.id+"/ack?oldversion="+c.version+"&version="+a.version+"&resource="+m.RESOURCE+"&token="+h.getInstance().getToken();jQuery.ajax({url:d,dataType:"json",type:"put",cache:!1,statusCode:{200:function(){h.getInstance().log("getVersion_sucess:",3,a.version)}}})}}function k(a){a.start||(a.start=0);a.size||(a.size=100);a.version||(a.version=-1);jQuery.ajax({url:m.SERVLET.REST_VERSION_SERVLET+m.MULTI_TENANCY.ETP_KEY+"/"+m.MULTI_TENANCY.APP_KEY+"/"+a.id+
"?version="+a.version+"&start="+a.start+"&size="+a.size+"&resource="+m.RESOURCE+"&token="+h.getInstance().getToken(),dataType:"json",cache:!1,success:function(c){a.complete&&a.complete();if(c.packets&&c.packets.length){for(var d in c.packets)try{for(var l=c.packets[d],e=b64decode(l.opcode),f="0x",g=0;g<e.length;g++)var t=e[g].charCodeAt().toString(16),f=f+(1==t.length?"0"+t:t);var h=JSON.parse(l.body);h.opcode=f;p.unshift(h)}catch(L){}p.sort(YYIMUtil.array.comparisonAsc("dateline"));c.packets.length>=
c.size?(a.start+=a.size,k(a)):n(c,a)}else c.packets&&c.packets.length||n(c,a)},error:function(c){h.getInstance().log("getOfflineMessage_error:",0,c.statusText);a.error&&a.error()}})}function n(c,d){if(p.length){for(var e in p)if(p[e].id)switch(p[e].opcode){case "0x"+OPCODE.PRESENCE.SEND.toString(16):h.getInstance().onSubscribe({from:f.getID(p[e].from),type:p[e].type});break;case "0x"+OPCODE.USER_MESSAGE.SEND.toString(16):case "0x"+OPCODE.CHATGROUP_MESSAGE.SEND.toString(16):case "0x"+OPCODE.PUBACCOUNT_MESSAGE.SEND.toString(16):a(p[e],
p[e].type);break;default:h.getInstance().log("unHandle_Packet:",3,p[e])}d.version=c.version-p.length;p=[];g(c,d)}d.success&&d.success()}var r=new SNSBaseList,p=[];return{monitor:function(){var c=d.getInstance();c.registerHandler(OPCODE.USER_MESSAGE.KEY,function(c){a(c,c.type)});c.registerHandler(OPCODE.CHATGROUP_MESSAGE.KEY,function(c){a(c,c.type)});c.registerHandler(OPCODE.PUBACCOUNT_MESSAGE.KEY,function(c){a(c,c.type)});c.registerHandler(OPCODE.RECEIPTS.KEY,function(a){a.from=f.getID(a.from);a.to=
f.getID(a.to);h.getInstance().onReceipts(a)});c.registerHandler(OPCODE.SYNC_MESSAGE.KEY,function(c){a(c,c.type)});c.registerHandler(OPCODE.TRANSPARENT_MESSAGE.KEY,function(a){if(!0!==r.get(a.id)){r.add(a.id,!0);a.to=f.getID(a.to);try{h.getInstance().onTransparentMessage(a)}catch(c){YYIMChat.log("TransparentMessHandleError:",0,a)}}})},sendMessage:function(a){var c,l=a.body||{},e={id:a.id,type:a.type||"chat",contentType:l.contentType||y.TEXT,dateline:(new Date).getTime()+m.TIMECORRECTION.RESULT,content:{atuser:l.atuser,
extend:l.extend,content:l.content}},g=OPCODE.USER_MESSAGE.SEND;"groupchat"==a.type?(c=f.buildChatGroupJID(f.getNode(a.to)),g=OPCODE.CHATGROUP_MESSAGE.SEND):"pubaccount"==a.type?(c=f.buildPubAccountJID(f.getNode(a.to)),g=OPCODE.PUBACCOUNT_MESSAGE.SEND):(e.receipts="1",c=a.resource?"anonymous"==a.resource.toLowerCase()?f.buildUserJID(f.getID(a.to),a.resource.toUpperCase()):a.to==YYIMChat.getUserID()?f.buildUserJID(f.getNode(a.to),a.resource):f.buildUserJID(f.getNode(a.to)):f.buildUserJID(f.getNode(a.to)));
e.to=c;a.style&&(e.content.style=a.style);d.getInstance().send(new JumpPacket(e,g),function(c){if(40302==c.code)a.error&&a.error();else if(c&&1==c.state)h.getInstance().onReceipts(c)});c={id:a.id,type:a.type,data:{content:l.content,contentType:l.contentType,dateline:e.dateline,extend:a.extend}};"groupchat"===c.type?(c.to=YYIMChat.getUserID(),c.from={room:f.getID(a.to),roster:YYIMChat.getUserID()}):(c.to=f.getID(a.to),c.from=YYIMChat.getUserID());c.body=c.data;c.data.content.path&&(c.data.content.attachId=
c.data.content.path,c.data.content.path=YYIMChat.getFileUrl(c.data.content.path));a.style&&(c.data.style=a.style);a.success&&a.success(c)},addGroupMember:function(a,c){d.getInstance().send(new JumpPacket({to:a,invites:c},OPCODE.INVITE_USERS.SEND))},getHistoryMessage:function(a){var c=m.SERVLET.REST_HISTORY_SERVLET+m.MULTI_TENANCY.ETP_KEY+"/"+m.MULTI_TENANCY.APP_KEY+"/"+YYIMChat.getUserID()+"?token="+h.getInstance().getToken()+"&start="+a.start+"&size="+a.num+"&peer=";if("pubaccount"==a.chatType)c=
m.SERVLET.REST_HISTORY_SERVLET+m.MULTI_TENANCY.ETP_KEY+"/"+m.MULTI_TENANCY.APP_KEY+"/pubaccount/"+a.id+"?token="+h.getInstance().getToken()+"&start="+a.start+"&size="+a.num,a.contentType&&(c+="&contentType="+a.contentType);else if("groupchat"==a.chatType)c=m.SERVLET.REST_HISTORY_SERVLET+m.MULTI_TENANCY.ETP_KEY+"/"+m.MULTI_TENANCY.APP_KEY+"/historymuc/"+a.id+"?token="+h.getInstance().getToken()+"&start="+a.start+"&size="+a.num;else if("chat"==a.chatType&&(c=a.resource&&"anonymous"==a.resource?c+a.id:
c+f.getNode(a.id),a.contentType))for(var d in y)if(a.contentType==y[d]){c+="&contentType="+a.contentType;break}h.getInstance().log("\u5386\u53f2\u8bb0\u5f55\uff1arequest URL",2,c);jQuery.ajax({url:c,dataType:"json",cache:!1,success:function(c){YYIMChat.log("\u5386\u53f2\u8bb0\u5f55\uff1adata",2,c);for(var d=[],l=0;c.result&&l<c.result.length;l++){var e={fromId:f.getID(c.result[l].sender||c.result[l].pubaccount),toId:f.getID(c.result[l].receiver||h.getInstance().getUserID()),msgId:c.result[l].packetId||
c.result[l].messageID,contentType:c.result[l].contentType,dateline:c.result[l].dateline||c.result[l].ts,packetId:c.result[l].packetId||c.result[l].messageID,type:a.chatType};a.chatType&&"groupchat"==a.chatType&&(e.messageID=c.result[l].packetId||c.result[l].messageID,e.fromId=f.getID(c.result[l].mucId),e.fromRoster=f.getID(c.result[l].sender),e.from={room:f.getID(c.result[l].mucId),roster:f.getID(c.result[l].sender)});if(c.result[l].content){var g=e,t;if(t=c.result[l].content){t=JSON.parse(t);try{isNaN(Number(t.content))&&
(t.content=JSON.parse(t.content),t.content.style&&(t.style=t.content.style,delete t.content.style),t.content.content&&(t.content=t.content.content))}catch(k){}}else t=null;g.body=t;e.body.contentType=c.result[l].contentType;e.body.dateline=c.result[l].dateline||c.result[l].ts;e.body.content&&e.body.contentType&&(e.body.contentType==y.IMAGE||e.body.contentType==y.FILE)&&(e.body.content.attachId=e.body.content.path,e.body.content.path=e.body.content.path?YYIMChat.getFileUrl(e.body.content.path):null);
d.push(e)}}YYIMCommonUtil.isFunction(a.success)&&a.success({count:Number(c.count),result:d})},error:function(c){a.error&&a.error();h.getInstance().log("getHistoryMessage_error:",0,c.statusText)},complete:function(){a.complete&&a.complete()}})},getOfflineMessage:k,sendReceiptsPacket:c,sendReadedReceiptsPacket:e}}(),C=function(){return{monitor:function(){var a=d.getInstance();a.registerHandler(OPCODE.PRESENCE.KEY,function(a){if(a.type&&"unavailable"!=a.type)h.getInstance().onSubscribe({from:f.getID(a.from),
type:a.type});else{var c={from:f.getID(a.from),resource:f.getResource(a.from),type:a.type,show:a.show,status:a.status};A.getInstance().addToOnline(c.from);a.type&&"unavailable"==a.type&&(c.show=x.UNAVAILABLE,c.status=x.UNAVAILABLE,A.getInstance().removeFromOnline(c.from));YYIMCommonUtil.isStringAndNotEmpty(c.status)||(c.show=x.CHAT,c.status=x.CHAT);h.getInstance().onPresence(c)}});a.registerHandler(OPCODE.CHATGROUP.KEY,function(a){if("unavailable"==a.type)h.getInstance().onRoomMemerPresence({room:f.getID(a.from),
member:{id:f.getID(a.jid)},type:"quit"});else h.getInstance().onRoomMemerPresence({room:f.getID(a.from),member:{id:f.getID(a.jid),nick:a.name?a.name:f.getID(a.jid),affiliation:a.affiliation,role:a.role},type:"join"})})},addRosterItem:function(a){d.getInstance().send(new JumpPacket({type:"subscribe",to:a},OPCODE.PRESENCE.SEND))},approveSubscribe:function(a){d.getInstance().send(new JumpPacket({type:"subscribed",to:a},OPCODE.PRESENCE.SEND))},rejectSubscribe:function(a){d.getInstance().send(new JumpPacket({type:"unsubscribed",
to:a},OPCODE.PRESENCE.SEND))},setPresence:function(a){var c={};YYIMCommonUtil.isStringAndNotEmpty(a.show)&&(c.show=a.show);YYIMCommonUtil.isStringAndNotEmpty(a.status)&&(c.status=a.status);YYIMCommonUtil.isStringAndNotEmpty(a.priority)&&(c.priority=a.priority);YYIMCommonUtil.isStringAndNotEmpty(a.type)&&(c.type=a.type);d.getInstance().send(new JumpPacket(c,OPCODE.PRESENCE.SEND))},addPubAccount:function(a){d.getInstance().send(new JumpPacket({type:"subscribe",to:a.jid},OPCODE.PRESENCE.SEND),function(a,
c){c.complete&&c.complete();a.from=f.getID(a.from);a.to=f.getID(a.to);c.success&&c.success(a)},a)},removePubAccount:function(a){d.getInstance().send(new JumpPacket({id:a.id,type:"unsubscribe",to:a.to},OPCODE.PRESENCE.SEND),function(a,c){c.complete&&c.complete();a.from=f.getID(a.from);a.to=f.getID(a.to)||h.getInstance().getUserID();c.success&&c.success(a)},a)},joinChatGroup:function(a){var c={to:a.jid+"/"+h.getInstance().getUserNode()};d.getInstance().send(new JumpPacket(c,OPCODE.CHATGROUP.SEND),function(c,
d){a.complete&&a.complete();a.success&&a.success({id:f.getID(c.from),affiliation:c.affiliation,role:c.role})},a)},delGroupMember:function(a,c,e){var f=parseInt(1E5+1E5*Math.random());0<c.indexOf("@")&&(c=c.split("@")[0]);d.getInstance().send(new JumpPacket({id:f,to:a,member:c,role:"none"},OPCODE.DEL_GROUPMEMBER.SEND),function(a){e&&e(a)})},quitChatGroup:function(a){d.getInstance().send(new JumpPacket({type:"unavailable",to:a+"/"+h.getInstance().getUserNode()},OPCODE.CHATGROUP.SEND),function(){})}}}(),
G=function(){return{monitor:function(){d.getInstance().registerHandler(OPCODE.UPDATE_WHITEBOARD.KEY,function(a){a.from=f.getID(a.from);h.getInstance().onWhiteBoardUpdated(a)})},operateWhiteBoard:function(a){d.getInstance().send(new JumpPacket({id:a.id,wid:a.wid,name:a.name,origin:f.buildUserJID(f.getNode(a.origin)),operation:a.operation},OPCODE.OPERATE_WHITEBOARD.SEND),function(a,c){c.complete&&c.complete();a.from&&(a.from=f.getID(a.from));a.to&&(a.to=f.getID(a.to));c.success&&c.success(a)},a)},listenWhiteBoard:function(a){d.getInstance().send(new JumpPacket({id:a.id,
wid:a.wid,operation:a.operation},OPCODE.LISTEN_WHITEBOARD.SEND),function(a,c){c.complete&&c.complete();a.from&&(a.from=f.getID(a.from));a.to&&(a.to=f.getID(a.to));c.success&&c.success(a)},a)},updateWhiteBoard:function(a){var c={id:a.id,from:a.from,wid:a.wid,nodeId:a.nodeId,nodeContent:a.nodeContent,nodeText:a.nodeText,operation:a.operation};d.getInstance().send(new JumpPacket(c,OPCODE.UPDATE_WHITEBOARD.SEND),function(a,c){c.complete&&c.complete();a.from&&(a.from=f.getID(a.from));c.success&&c.success(a)},
a)}}}();a.prototype.startPing=function(){d.getInstance().connected()&&(this.pingInterval=setInterval(this.ping.bind(this),m.PING.INTERVAL))};a.prototype.stopPing=function(){clearTimeout(this.pingTimeout);clearInterval(this.pingInterval)};a.prototype.ping=function(){if(!((new Date).getTime()-this.lastPongTime<m.PING.DURATION)){var a=new JumpPacket(null,OPCODE.PING.SEND);try{d.getInstance().send(a),this.pingTimeout=setTimeout(this.timeoutHandler.bind(this),m.PING.TIMEOUT)}catch(c){F.log("SNSConnectService.ping",
0,c),this.stopPing(),h.getInstance().onConnectError({errorCode:408,message:"\u8fde\u63a5\u5931\u8d25"})}}};a.prototype.pong=function(){this.lastPongTime=(new Date).getTime();clearTimeout(this.pingTimeout)};a.prototype.timeoutHandler=function(){this.stopPing();h.getInstance().onConnectError({errorCode:408,message:"\u8fde\u63a5\u5931\u8d25"})};c.prototype._init=function(){F.log("YYIMConnectEventHandler.prototype.registerHandler",3);if(!this._inited){var a=d.getInstance();a.registerHandler("onConnect",
this.onConnected);a.registerHandler("onDisconnect",this.onDisConnect);a.registerHandler("onStatusChanged",this.connectStatusChangeHandler);a.registerHandler(OPCODE.STREAM_ERROR.KEY,this.onStreamError);a.registerHandler(OPCODE.PACKET_ERROR.KEY,this.onPacketError);this._inited=!0}};c.prototype.onConnected=function(){h.getInstance().getTimeCorrection(function(a){m.TIMECORRECTION.RESULT=a});h.getInstance().onOpened();d.getInstance().getDaemon().startPing()};c.prototype.onConnectError=function(a){F.log("YYIMConnectEventHandler.prototype.onConnectError ",
0,a);errorCode=a.getAttribute("code");d.getInstance().getDaemon().stopPing();if(401==errorCode||401==errorCode/10)h.getInstance().onAuthError({errorCode:401,message:"\u7528\u6237\u540d\u6216\u5bc6\u7801\u9519\u8bef"});else h.getInstance().onConnectError({errorCode:errorCode,message:"\u8fde\u63a5\u5931\u8d25"})};c.prototype.onStreamError=function(a){F.log("YYIMConnectEventHandler.prototype.onPacketError ",0,a);d.getInstance().getDaemon().stopPing();if(401==a.code||401==a.code/10)h.getInstance().onAuthError({errorCode:401,
message:"\u7528\u6237\u540d\u6216\u5bc6\u7801\u9519\u8bef"});else h.getInstance().onConnectError({errorCode:a.code,message:a.message})};c.prototype.onPacketError=function(a){F.log("YYIMConnectEventHandler.prototype.onPacketError ",0,a)};c.prototype.onDisConnect=function(){h.getInstance().onClosed();d.getInstance().getDaemon().stopPing()};c.prototype.connectStatusChangeHandler=function(a){F.log("connectStatusChangeHandler",3,a);h.getInstance().onStatusChanged(a)};d.getInstance=function(){d._instance||
(d._instance=new d,d._instance._init());return d._instance};d.prototype.getDaemon=function(){return this.daemon};d.prototype._init=function(){C.monitor();r.monitor();u.monitor();G.monitor();this.eventHandler._init();this.registerHandler(OPCODE.AUTH.KEY,function(a){var c=new JSJaCJID(a.jid);a=f.getID(a.jid);h.getInstance()._user={jid:c,name:a};h.getInstance().onUserBind(a,c.getResource())});this.registerHandler(OPCODE.PING.KEY,this.getDaemon().pong.bind(this.getDaemon()))};d.prototype.registerHandler=
function(a,c,d,e){if(this.connection)this.connection.registerHandler.apply(this.connection,arguments);else throw"connection is undefined!";};d.prototype.connected=function(){return this.connection&&this.connection.connected()?!0:!1};d.prototype.getConnection=function(){this.connection||(m.useWebSocket()?this.connection=new JSJaCWebSocketConnection({httpbase:m.getWebSocketUrl()}):this.connection=new JSJaCHttpBindingConnection({httpbase:m.getHttpBindUrl(),timerval:m.CONNECTION.TIMERVAL,wait:m.CONNECTION.WAIT}));
return this.connection};d.prototype.connect=function(a,c,d){this.connectArg||(this.connectArg=m.getConnectionArgObj());a&&(this.connectArg.username=a,this.connectArg.password=c);h.getInstance()._user={jid:new JSJaCJID(this.connectArg.username+"@"+g+"/"+this.connectArg.resource),name:this.connectArg.username};this.connection.connect(this.connectArg)};d.prototype.disconnect=function(){this.daemon.stopPing();this.connection&&this.connection.disconnect()};d.prototype.send=function(a,c,d,e){this.waitingList.push({packet:a,
callback:c,data:d,callbackContext:e});this.sending||this.sendInterval()};d.prototype.sendInterval=function(){var a=this;if(this.waitingList.length){this.sending=!0;var c=this.waitingList[0],d=(new Date).getTime()-this.lastSendTime;d>=m.SENDINTERVAL?(this.sendJumpPacket(c),this.waitingList.shift(),this.lastSendTime=(new Date).getTime(),this.sendInterval()):setTimeout(function(){a.sendJumpPacket(c);a.waitingList.shift();a.lastSendTime=(new Date).getTime();a.sendInterval()},m.SENDINTERVAL-d)}else this.sending=
!1};d.prototype.sendJumpPacket=function(a){return a.callbackContext?this.connection.sendJumpPacket(a.packet,a.callback.bind(a.callbackContext),a.data):this.connection.sendJumpPacket(a.packet,a.callback,a.data)};e.prototype.get=function(){var a=this.xhr;a.open("GET",this.url,!0);e.prototype._listenFn.call(this);a.send()};e.prototype.post=function(){var a=this.xhr;a.open("POST",this.url,!0);e.prototype._listenFn.call(this);a.setRequestHeader("Content-Type","x-www-form-urlencoded");a.send(this.data)};
e.prototype.isLoop=function(a){this.loop=a};e.prototype.stopLoop=function(){clearTimeout(_self.timeoutIndex)};e.prototype._listenFn=function(){var a=this,c=this.xhr;this.timeoutIndex=setTimeout(function(){a.loop&&e.prototype.get.call(a);a.eCallback(c.responseText)},a.timeout);c.onreadystatechange=function(){4==c.readyState&&(clearTimeout(a.timeoutIndex),200==c.status?a.sCallback(c.responseText):a.eCallback(c.responseText))}};var M=function(){function a(c){var d,l=0;jQuery.ajax({url:m.SERVLET.REST_SYSTEM_SERVLET_SAFE+
"time",type:"get",cache:!1,beforeSend:function(){d=(new Date).getTime()},success:function(a){l=(new Date).getTime();c&&c.success&&c.success(a-(d+l)/2,l-d)},error:function(a){c&&c.error&&c.error()}})}return{multiPartyCall:function(a){if(!0===a.accountMmanaged){var c={etpId:m.MULTI_TENANCY.ETP_KEY,appId:m.MULTI_TENANCY.APP_KEY,caller:a.caller,phones:a.phones,username:h.getInstance().getUserNode()};jQuery.ajax({url:m.SERVLET.REST_USER_SERVLET_SAFE+"voip/make?token="+h.getInstance().getToken(),type:"post",
data:JSON.stringify(c),dataType:"json",cache:!1,processData:!1,contentType:"application/json",headers:{},success:function(c){a.success&&a.success(c)},error:function(c){a.error&&a.error()}})}else c=(new Date).getTime(),c={caller:a.caller,phones:a.phones,account_identify:a.account,userId:h.getInstance().getUserBareJID(),timestamp:c,sign:hex_sha1(a.account+a.key+c)},jQuery.ajax({url:m.MULTIPARTYCALL.ADDRESS,type:"get",data:c,dataType:"jsonp",cache:!1,jsonp:"callback",success:function(c){a.success&&a.success(c)},
error:function(c){a.error&&a.error()}})},getTimeCorrection:function(c){for(var d=[],e=!1,f=0;f<m.TIMECORRECTION.TIMES;f++)a({success:function(a,l){d.push(a);if(l<m.TIMECORRECTION.RESIDUAL)e||(e=!0,YYIMCommonUtil.isFunction(c)&&c(Math.round(a)));else if(d.length===m.TIMECORRECTION.TIMES){var f=0,g;for(g in d)f+=d[g];e=!0;YYIMCommonUtil.isFunction(c)&&c(Math.round(f/m.TIMECORRECTION.TIMES))}}})}}}(),s=function(){this._provider};s.getInstance=function(){s._instance||(s._instance=new s);return s._instance};
s.prototype.init=function(a){this._provider=a&&a.provider?a.provider:new I};s.prototype.getProvider=function(){this._provider||(this._provider=new I);return this._provider};s.prototype.getChatGroups=function(a){this.getProvider()&&YYIMCommonUtil.isFunction(this.getProvider().getChatGroups)&&this.getProvider().getChatGroups(a)};s.prototype.addChatGroup=function(a){C.joinChatGroup({jid:f.buildChatGroupJID(f.getNode(a.node)),success:function(){u.configChatGroup({jid:this.jid,name:a.name,desc:a.desc,
error:a.error,success:function(){a.success&&a.success({name:a.name,node:a.node,id:a.id,nickname:h.getInstance().getUserID()})},complete:a.complete})},error:function(){a.error&&a.error()}});this.getProvider()&&YYIMCommonUtil.isFunction(this.getProvider().addChatGroup)&&this.getProvider().addChatGroup(a)};s.prototype.createChatGroup=function(a){u.createChatGroup({id:Math.uuid(),name:a.name,members:a.members,success:function(c){a.success&&a.success(c)},complete:function(){a.complete&&a.complete()}})};
s.prototype.transferChatGroup=function(a){u.transferChatGroup({id:Math.uuid(),to:a.to,newOwner:a.newOwner,success:function(c){a.success&&a.success(c)},complete:function(){a.complete&&a.complete()}})};s.prototype.dismissChatGroup=function(a){u.dismissChatGroup({id:Math.uuid(),to:a.to,success:function(c){a.success&&a.success(c)},complete:function(){a.complete&&a.complete()}})};s.prototype.inviteGroupMember=function(a){u.inviteGroupMember({id:Math.uuid(),to:a.to,members:a.members,success:function(c){a.success&&
a.success(c)},complete:function(){a.complete&&a.complete()}})};s.prototype.modifyChatGroupInfo=function(a){u.modifyChatGroupInfo({id:Math.uuid(),to:a.to,name:a.name,success:function(c){a.success&&a.success(c)},complete:function(){a.complete&&a.complete()}})};s.prototype.kickGroupMember=function(a){u.kickGroupMember({id:Math.uuid(),to:a.to,member:a.member,success:function(c){a.success&&a.success(c)},complete:function(){a.complete&&a.complete()}})};s.prototype.exitChatGroup=function(a){u.exitChatGroup({id:Math.uuid(),
to:a.to,success:function(c){a.success&&a.success(c)},complete:function(){a.complete&&a.complete()}})};s.prototype.collectChatGroup=function(a){u.collectChatGroup({id:Math.uuid(),to:a.to,type:a.type,success:function(c){a.success&&a.success(c)},complete:function(){a.complete&&a.complete()}})};s.prototype.delGroupMember=function(a,c,d){C.delGroupMember(a,c,d)};s.prototype.quitChatGroup=function(a){C.quitChatGroup(a);this.getProvider()&&YYIMCommonUtil.isFunction(this.getProvider().quitChatGroup)&&this.getProvider().quitChatGroup(a)};
s.prototype.queryChatGroup=function(a){this.getProvider()&&YYIMCommonUtil.isFunction(this.getProvider().queryChatGroup)&&this.getProvider().queryChatGroup(a)};s.prototype.joinChatGroup=function(a){C.joinChatGroup(a)};s.prototype.updateChatGroup=function(a){u.configChatGroup(a)};var I=function(){};I.prototype.getChatGroups=function(a){u.getChatGroups(a)};I.prototype.addChatGroup=function(a){};I.prototype.quitChatGroup=function(a){};I.prototype.queryChatGroup=function(a){u.queryChatGroup(a)};var E=
function(){this._provider};E.getInstance=function(){E._instance||(E._instance=new E);return E._instance};E.prototype.init=function(a){this._provider=a&&a.provider?a.provider:new J};E.prototype.getProvider=function(){this._provider||(this._provider=new J);return this._provider};E.prototype.getGroupMembers=function(a){this.getProvider()&&YYIMCommonUtil.isFunction(this.getProvider().getGroupMembers)&&this.getProvider().getGroupMembers(a)};E.prototype.addGroupMember=function(a,c){r.addGroupMember(a,c);
this.getProvider()&&YYIMCommonUtil.isFunction(this.getProvider().addGroupMember)&&this.getProvider().addGroupMember(a,c)};var J=function(){};J.prototype.getGroupMembers=function(a){u.getGroupMembers(a)};J.prototype.addGroupMember=function(a,c){};var A=function(){this._provider;this._onlineList=new SNSBaseList};A.getInstance=function(){A._instance||(A._instance=new A);return A._instance};A.prototype.addToOnline=function(a){this._onlineList.add(a,!0)};A.prototype.removeFromOnline=function(a){this._onlineList.remove(a)};
A.prototype.init=function(a){this._provider=a&&a.provider?a.provider:new H};A.prototype.getProvider=function(){this._provider||(this._provider=new H);return this._provider};A.prototype.getRosterItems=function(a){this.getProvider()&&YYIMCommonUtil.isFunction(this.getProvider().getRosterItems)&&this.getProvider().getRosterItems(a)};A.prototype.addRosterItem=function(a){C.addRosterItem(a);this.getProvider()&&YYIMCommonUtil.isFunction(this.getProvider().addRosterItem)&&this.getProvider().addRosterItem(a)};
A.prototype.deleteRosterItem=function(a){u.deleteRosterItem(a);this.getProvider()&&YYIMCommonUtil.isFunction(this.getProvider().deleteRosterItem)&&this.getProvider().deleteRosterItem(a)};A.prototype.queryRosterItem=function(a){this.getProvider()&&YYIMCommonUtil.isFunction(this.getProvider().queryRosterItem)&&this.getProvider().queryRosterItem(a)};A.prototype.getRostersPresence=function(a){this.getProvider()&&YYIMCommonUtil.isFunction(this.getProvider().getRostersPresence)&&this.getProvider().getRostersPresence(a)};
var H=function(){};H.prototype.getRosterItems=function(a){u.getRosterItems(a)};H.prototype.addRosterItem=function(a){};H.prototype.deleteRosterItem=function(a){};H.prototype.queryRosterItem=function(a){u.queryRosterItem(a)};H.prototype.getRostersPresence=function(a){u.getRostersPresence(a)};var z=function(){},F=new function(a){this.level=a?a:0==a?0:3;this.start=function(){};this.log=function(a,c,d,e){if(m.LOG.ENABLE&&(c=c?c:0==c?0:3,!(c>this.level)&&"undefined"!=typeof console&&"undefined"!=typeof console.group))try{console.group(a);
switch(c){case 0:console.error(a);console.trace();break;case 1:console.warn(a);console.trace();break;case 2:console.info(a);break;case 4:console.debug(a);break;default:console.log(a)}var l=arguments.length;if(2<l)for(var f=2;f<l;f++){var g=arguments[f];g&&(g instanceof JSJaCPacket?console.info(g.doc.xml):console.debug(g))}console.groupEnd()}catch(h){try{console.error(h)}catch(k){}}};this.logParam=function(a){this.log("arguments:",a||3,this.logParam.caller.arguments)};this.setLevel=function(a){this.level=
a;return this};this.getLevel=function(){return this.level}}(m.LOG.FILTER_LEVEL),h=function(){this._user;this.init();this._token={};this._anonymousUser=!1;this.appkey;this.version="2.0"};h.getInstance=function(){h._instance||(h._instance=new h);return h._instance};h.prototype.log=function(a,c,d,e){F.log(a,c,d,e)};h.prototype.init=function(a){a=a||{};this.onOpened=a.onOpened||z;this.onClosed=a.onClosed||z;this.onAuthError=a.onAuthError||z;this.onStatusChanged=a.onStatusChanged||z;this.onConnectError=
a.onConnectError||z;this.onUserBind=a.onUserBind||z;this.onPresence=a.onPresence||z;this.onSubscribe=a.onSubscribe||z;this.onRosterDeleted=a.onRosterDeleted||z;this.onRosterUpdateded=a.onRosterUpdateded||z;this.onGroupUpdate=a.onGroupUpdate||z;this.onTransferGroupOwner=a.onTransferGroupOwner||z;this.onKickedOutGroup=a.onKickedOutGroup||z;this.onPubaccountUpdate=a.onPubaccountUpdate||z;this.onRoomMemerPresence=a.onRoomMemerPresence||z;this.onMessage=a.onMessage||z;this.onReceipts=a.onReceipts||z;this.onTextMessage=
a.onTextMessage||z;this.onPictureMessage=a.onPictureMessage||z;this.onFileMessage=a.onFileMessage||z;this.onShareMessage=a.onShareMessage||z;this.onSystemMessage=a.onSystemMessage||z;this.onPublicMessage=a.onPublicMessage||z;this.onDeviceMessage=a.onDeviceMessage||z;this.onAudoMessage=a.onAudoMessage||z;this.onLocationMessage=a.onLocationMessage||z;this.onWhiteBoardMessage=a.onWhiteBoardMessage||z;this.onTransparentMessage=a.onTransparentMessage||z;this.onWhiteBoardUpdated=a.onWhiteBoardUpdated||
z};h.prototype.initUpload=function(){if(arguments&&SNSIMUploadUseFlash&&"function"==typeof SNSIMUploadUseFlash.prototype.addUploader)for(var a=0;a<arguments.length;a++){var c=arguments[a];"string"==typeof c.button_placeholder_id&&SNSIMUploadUseFlash.getInstance().addUploader(c)}};h.prototype.initSDK=function(a,c,d){var e=m.MULTI_TENANCY;e.ENABLE=!0;e.APP_KEY=a;e.ETP_KEY=c;this.appkey=e.SEPARATOR+e.APP_KEY+e.SEPARATOR+e.ETP_KEY;d&&(k=d.address||k,m.CONNECTION.HTTP_BASE=k,n=d.wsport||n,m.CONNECTION.WS_PORT=
n,v=d.hbport||v,m.CONNECTION.HTTP_BIND_PORT=v,w=d.servlet||w,p=d.safeServlet||p,m.SERVLET={FILE_UPLOAD_SERVLET:w+"sysadmin/fileUpload",FILE_DOWNLOAD_SERVLET:w+"sysadmin/download",FILE_DELETE_SERVLET:w+"sysadmin/cancel",AVATAR_SERVLET:w+"sysadmin/avatar",REST_RESOURCE_SERVLET:w+"sysadmin/rest/resource/",REST_HISTORY_SERVLET:w+"sysadmin/rest/history/",REST_VERSION_SERVLET:w+"sysadmin/rest/version/",REST_USER_SERVLET:w+"sysadmin/rest/user/",REST_UPLOAD_SERVLET:w+"im_upload/rest/resource/",REST_DOWNLOAD_SERVLET:w+
"im_download/rest/resource/",REST_TRANSFORM_SERVLET:w+"im_download/rest/transform/resource/",REST_USER_SERVLET_SAFE:p+"sysadmin/rest/user/",REST_SYSTEM_SERVLET_SAFE:p+"sysadmin/rest/system/"})};h.prototype.getTenancy=function(){return m.MULTI_TENANCY};h.prototype.getAppkey=function(){return this.appkey};h.prototype.setRosterProvider=function(a){A.getInstance().init({provider:a||new H})};h.prototype.setChatGroupProvider=function(a){s.getInstance().init({provider:a||new I})};h.prototype.setChatGroupMemberProvider=
function(a){E.getInstance().init({provider:a||new J})};h.prototype.setServer=function(a,c){m.CONNECTION.SERVER_NAME=a;m.CONNECTION.HTTP_BASE=c?c:a};h.prototype.disConnect=function(){d.getInstance().disconnect()};h.prototype.connect=function(){d.getInstance().connect()};h.prototype.getToken=function(){return this._token.token};h.prototype.getTokenExpiration=function(){return this._token.expiration};h.prototype.login=function(a,c,e){this._token={token:c,expiration:e};!YYIMCommonUtil.isStringAndNotEmpty(a)&&
m.IS_ANONYMOUS&&(this._anonymousUser=!0);!this.isAnonymous()&&m.MULTI_TENANCY.ENABLE&&(a=f.getNode(a));d.getInstance().connect(a,c)};h.prototype.logout=function(){d.getInstance().disconnect()};h.prototype.getUserBareJID=function(){return this._user.jid.getBareJID()};h.prototype.getUserFullJID=function(){return this._user.jid.toString()};h.prototype.getUserNode=function(){return f.getNode(this.getUserBareJID())};h.prototype.getUserID=function(){return f.getID(this.getUserBareJID())};h.prototype.getUserResource=
function(){return m.RESOURCE};h.prototype.fullSyncRoster=function(a){if(YYIMArrayUtil.isArray(a)){for(var c=a.length,d=[];c--;)YYIMCommonUtil.isStringAndNotEmpty(a[c].id)&&d.push({jid:f.buildUserJID(f.getNode(a[c].id)),name:a[c].name?a[c].name:a[c].id});u.fullSyncRoster(d)}};h.prototype.deltaSyncRoster=function(a,c){var d=-2,e=-2,g=[],h=[];if(YYIMArrayUtil.isArray(a))for(d=a.length;d--;)YYIMCommonUtil.isStringAndNotEmpty(a[d])&&g.push(f.buildUserJID(f.getNode(a[d])));if(YYIMArrayUtil.isArray(c))for(e=
c.length;e--;)YYIMCommonUtil.isStringAndNotEmpty(c[e].id)&&h.push({jid:f.buildUserJID(f.getNode(c[e].id)),name:c[e].name?c[e].name:c[e].id});-2===d&&-2===e||u.deltaSyncRoster(g,h)};h.prototype.fullSyncChatGroup=function(a){if(YYIMArrayUtil.isArray(a)){for(var c=a.length,d=[];c--;)YYIMCommonUtil.isStringAndNotEmpty(a[c].id)&&d.push({id:f.getID(a[c].id),name:a[c].name?a[c].name:a[c].id});u.fullSyncChatGroup(d)}};h.prototype.deltaSyncChatGroup=function(a,c){var d=-2,e=-2,g=[],h=[];if(YYIMArrayUtil.isArray(a))for(d=
a.length;d--;)YYIMCommonUtil.isStringAndNotEmpty(a[d])&&g.push(f.getID(a[d]));if(YYIMArrayUtil.isArray(c))for(e=c.length;e--;)YYIMCommonUtil.isStringAndNotEmpty(c[e].id)&&h.push({id:f.getID(c[e].id),name:c[e].name?c[e].name:c[e].id});-2===d&&-2===e||u.deltaSyncChatGroup(g,h)};h.prototype.setPresence=function(a){var c={};if(a){if(a.show)for(var d in x)if(x[d]===a.show){c.show=x[d];break}if(!c.show&&a.status)for(d in x)if(x[d]===a.status){c.show=x[d];break}c.status=a.status}c.show=c.show?c.show:x.AVAILABLE;
C.setPresence(c)};h.prototype.getVCard=function(a){var c={success:a.success,error:a.error,complete:a.complete};YYIMCommonUtil.isStringAndNotEmpty(a.id)&&(c.jid=f.buildUserJID(f.getNode(a.id)));u.getVCard(c)};h.prototype.getVCards=function(a){u.getVCards({success:a.success,error:a.error,complete:a.complete})};h.prototype.setVCard=function(a){u.setVCard({vcard:{nickname:a.vcard.nickname,photo:a.vcard.photo,email:a.vcard.email,mobile:a.vcard.mobile,telephone:a.vcard.telephone,organization:a.vcard.organization,
gender:a.vcard.gender,number:a.vcard.number,remarks:a.vcard.remarks,location:a.vcard.location,position:a.vcard.position},success:a.success,error:a.error})};h.prototype.setVCardTag=function(a){a=a||{};if(YYIMArrayUtil.isArray(a.tag)){var c=this;u.setVCardTag({id:a.id,tag:a.tag,success:function(d){a.id&&a.id!==h.getInstance().getUserID()?a.success&&a.success(d):c.getVCard({id:d,success:function(c){a.success&&a.success(c)}})},error:a.error})}else a.error&&a.error()};h.prototype.getRosterItems=function(a){A.getInstance().getRosterItems(a)};
h.prototype.addRosterItem=function(a){YYIMCommonUtil.isStringAndNotEmpty(a)&&A.getInstance().addRosterItem(f.buildUserJID(f.getNode(a)))};h.prototype.approveSubscribe=function(a){YYIMCommonUtil.isStringAndNotEmpty(a)&&C.approveSubscribe(f.buildUserJID(f.getNode(a)))};h.prototype.rejectSubscribe=function(a){YYIMCommonUtil.isStringAndNotEmpty(a)&&C.rejectSubscribe(f.buildUserJID(f.getNode(a)))};h.prototype.deleteRosterItem=function(a){YYIMCommonUtil.isStringAndNotEmpty(a.id)&&A.getInstance().deleteRosterItem({jid:f.buildUserJID(f.getNode(a.id)),
success:a.success,error:a.error,complete:a.complete})};h.prototype.queryRosterItem=function(a){YYIMCommonUtil.isStringAndNotEmpty(a.keyword)&&A.getInstance().queryRosterItem(a)};h.prototype.getRostersPresence=function(a){YYIMArrayUtil.isArray(a.username)&&(a.username=JSON.stringify(a.username),A.getInstance().getRostersPresence(a))};h.prototype.getRecentContacts=function(a){u.getRecentContacts(a)};h.prototype.updateRosterItem=function(a){a&&a.roster&&YYIMCommonUtil.isStringAndNotEmpty(a.roster.id)&&
u.updateRosterItem({roster:{jid:f.buildUserJID(f.getNode(a.roster.id)),name:a.roster.name,groups:a.roster.groups},success:a.success,error:a.error})};h.prototype.queryChatGroup=function(a){YYIMCommonUtil.isStringAndNotEmpty(a.keyword)&&s.getInstance().queryChatGroup(a)};h.prototype.quitChatGroup=function(a){YYIMCommonUtil.isStringAndNotEmpty(a)&&s.getInstance().quitChatGroup(f.buildChatGroupJID(f.getNode(a)))};h.prototype.delGroupMember=function(a,c,d){YYIMCommonUtil.isStringAndNotEmpty(c)&&s.getInstance().delGroupMember(f.buildChatGroupJID(f.getNode(a)),
f.buildUserJID(f.getNode(c)),d)};h.prototype.joinChatGroup=function(a){YYIMCommonUtil.isStringAndNotEmpty(a.id)&&s.getInstance().joinChatGroup({jid:f.buildChatGroupJID(f.getNode(a.id)),success:a.success,error:a.error})};h.prototype.getChatGroupInfo=function(a){YYIMCommonUtil.isStringAndNotEmpty(a.id)&&u.getChatGroupInfo({jid:f.buildChatGroupJID(f.getNode(a.id)),success:a.success,error:a.error})};h.prototype.getPubAccount=function(a){u.getPubAccountItems(a)};h.prototype.addPubaccount=function(a){YYIMCommonUtil.isStringAndNotEmpty(a.id)?
C.addPubAccount({jid:f.buildPubAccountJID(f.getNode(a.id)),success:a.success,error:a.error}):a.error&&a.error()};h.prototype.removePubaccount=function(a){YYIMCommonUtil.isStringAndNotEmpty(a.id)?C.removePubAccount({id:Math.uuid(),to:f.buildPubAccountJID(f.getNode(a.id)),success:a.success,error:a.error}):a.error&&a.error()};h.prototype.queryPubaccount=function(a){u.queryPubaccount(a)};h.prototype.getChatGroups=function(a){s.getInstance().getChatGroups(a)};h.prototype.addGroupMember=function(a){if(YYIMCommonUtil.isStringAndNotEmpty(a.roomId)&&
YYIMArrayUtil.isArray(a.ids)){var c=f.buildChatGroupJID(f.getNode(a.roomId));a=a.ids.slice();for(var d=0,e=a.length;d<e;d++)a[d]=f.buildUserJID(f.getNode(a[d]));E.getInstance().addGroupMember(c,a)}};h.prototype.addChatGroup=function(a){YYIMCommonUtil.isStringAndNotEmpty(a.node)&&s.getInstance().addChatGroup(a)};h.prototype.createChatGroup=function(a){YYIMArrayUtil.isArray(a.members)||delete a.members;a.name?s.getInstance().createChatGroup(a):a.error&&a.error()};h.prototype.transferChatGroup=function(a){a&&
"string"==typeof a.newOwner&&a.to?(a.to=f.buildChatGroupJID(f.getNode(a.to)),s.getInstance().transferChatGroup(a)):a.error&&a.error()};h.prototype.dismissChatGroup=function(a){a&&a.to?(a.to=f.buildChatGroupJID(f.getNode(a.to)),s.getInstance().dismissChatGroup(a)):a.error&&a.error()};h.prototype.getGroupSharedFiles=function(a){a&&a.id&&u.getGroupSharedFiles(a)};h.prototype.inviteGroupMember=function(a){a.members&&YYIMArrayUtil.isArray(a.members)&&a.members.length&&a.to?(a.to=f.buildChatGroupJID(f.getNode(a.to)),
s.getInstance().inviteGroupMember(a)):a.error&&a.error()};h.prototype.modifyChatGroupInfo=function(a){a.name&&a.to?(a.to=f.buildChatGroupJID(f.getNode(a.to)),s.getInstance().modifyChatGroupInfo(a)):a.error&&a.error()};h.prototype.kickGroupMember=function(a){a.member&&"string"==typeof a.member&&a.to?(a.to=f.buildChatGroupJID(f.getNode(a.to)),s.getInstance().kickGroupMember(a)):a.error&&a.error()};h.prototype.exitChatGroup=function(a){a.to?(a.to=f.buildChatGroupJID(f.getNode(a.to)),s.getInstance().exitChatGroup(a)):
a.error&&a.error()};h.prototype.collectGroup=function(a){a.to?(a.to=f.buildChatGroupJID(f.getNode(a.to)),a.type="add",s.getInstance().collectChatGroup(a)):a.error&&a.error()};h.prototype.removeCollectGroup=function(a){a.to?(a.to=f.buildChatGroupJID(f.getNode(a.to)),a.type="remove",s.getInstance().collectChatGroup(a)):a.error&&a.error()};h.prototype.updateChatGroup=function(a){YYIMCommonUtil.isStringAndNotEmpty(a.id)&&s.getInstance().updateChatGroup({jid:f.buildChatGroupJID(f.getNode(a.id)),name:a.name,
desc:a.desc,photo:a.photo,error:a.error,success:a.success,complete:a.complete})};h.prototype.getGroupMembers=function(a){YYIMCommonUtil.isStringAndNotEmpty(a.id)&&E.getInstance().getGroupMembers({jid:f.buildChatGroupJID(f.getNode(a.id)),success:a.success,error:a.error,complete:a.complete})};h.prototype.getHistoryMessage=function(a){if(!a.start||isNaN(a.start))a.start=0;if(!a.num||isNaN(a.num))a.num=100;r.getHistoryMessage(a)};h.prototype.getOfflineMessage=function(a){a=a||{};r.getOfflineMessage({id:this.getUserID(),
success:a.success,error:a.error,complete:a.complete})};h.prototype.sendReceiptsPacket=function(a){r.sendReceiptsPacket(a)};h.prototype.sendReadedReceiptsPacket=function(a){r.sendReadedReceiptsPacket(a)};h.prototype.sendMessage=function(a){r.sendMessage(a)};h.prototype.sendAccessoryMessage=function(a){a.id=Math.uuid();var c=new SNSFile(a.body.content.name,a.body.content.attachId,a.body.content.size);a.body={content:c,contentType:a.contentType||y.FILE,dateline:(new Date).getTime()};YYIMChat.sendMessage(a)};
h.prototype.sendFormMessage=function(a){var c={token:this.getToken(),creator:this.getUserID()+"."+m.MULTI_TENANCY.APP_KEY+"."+m.MULTI_TENANCY.ETP_KEY,receiver:a.to+"."+m.MULTI_TENANCY.APP_KEY+"."+m.MULTI_TENANCY.ETP_KEY,mediaType:a.mediaType||2,randomId:Math.uuid(),name:a.file.name,size:a.file.size},d=m.SERVLET.REST_RESOURCE_SERVLET+m.MULTI_TENANCY.ETP_KEY+"/"+m.MULTI_TENANCY.APP_KEY+"/upload",d=d+("?"+jQuery.param(c));jQuery.ajax({xhr:function(){var c=new window.XMLHttpRequest;c.upload.addEventListener("progress",
function(c){if(c.lengthComputable){var d=c.loaded/c.total;a.progress&&a.progress({loaded:c.loaded,total:c.total,percent:d})}},!1);c.addEventListener("progress",function(c){if(c.lengthComputable){var d=c.loaded/c.total;a.progress&&a.progress({loaded:c.loaded,total:c.total,percent:d})}},!1);return c},url:d,type:"post",dataType:"json",data:a.data,processData:!1,contentType:!1,success:function(d){d&&d.attachId?(d={to:a.to,body:{content:{name:a.file.name,size:a.file.size,attachId:d.attachId}},type:a.type,
success:a.success},d.contentType=1===c.mediaType?y.IMAGE:y.FILE,h.getInstance().sendAccessoryMessage(d)):a.error&&a.error()},error:function(c,d){a.error&&a.error()},complete:function(c,d){a.complete&&a.complete()}})};h.prototype.sendShareMessage=function(a){a.content=a.sharebody||a.content;a.contentType=y.SHARE;this.postMessage(a)};h.prototype.sendWhiteBoardMessage=function(a){a.contentType=y.WHITEBOARD;this.postMessage(a)};h.prototype.sendTextMessage=function(a){a.content=a.msg||a.content;a.contentType=
y.TEXT;this.postMessage(a)};h.prototype.postMessage=function(a){a.id=Math.uuid();a.type=a.type||"chat";a.body={extend:a.extend,content:a.content,contentType:a.contentType,dateline:(new Date).getTime()};"groupchat"===a.type&&YYIMArrayUtil.isArray(a.atuser)&&(a.body.atuser=a.atuser);a.style&&"string"!=typeof a.style&&(a.body.style=JSON.stringify(a.style));this.sendMessage(a)};h.prototype.sendPic=function(a){var c=f.getNode(a.to),c="groupchat"==a.type?f.buildChatGroupJID(c):f.buildUserJID(c),c={fileTypeExts:"jpg;jpeg;png;bmp;gif",
fileSizeLimit:102400,breakPoints:!1,saveInfoLocal:!1,removeTimeout:100,uploader:m.SERVLET.FILE_UPLOAD_SERVLET,uploadIdPrefix:"image_upload_",inputId:a.fileInputId,to:c,type:y.IMAGE,chatType:a.type,onUploadSuccess:a.success,onUploadProgress:a.progress,onUploadError:a.error,showProcess:!1,processId:"udnProcessBar"};a.resource&&(c.resource=a.resource);FileUpload.getInstance(a.fileInputId,c);FileUpload.getInstance(a.fileInputId).sendFile(document.getElementById(a.fileInputId))};h.prototype.sendFile=function(a){var c=
f.getNode(a.to),c="groupchat"==a.type?f.buildChatGroupJID(c):f.buildUserJID(c),c={fileTypeExts:"*",fileSizeLimit:99999999,breakPoints:!0,saveInfoLocal:!0,removeTimeout:100,uploader:m.SERVLET.FILE_UPLOAD_SERVLET,uploadIdPrefix:"bp_upload_",inputId:a.fileInputId,to:c,type:y.FILE,chatType:a.type,onUploadSuccess:a.success,onUploadProgress:a.progress,onUploadError:a.error,showProcess:!0,processId:"udnProcessBar"};a.resource&&(c.resource=a.resource);FileUpload.getInstance(a.fileInputId,c);FileUpload.getInstance(a.fileInputId).sendFile(document.getElementById(a.fileInputId))};
h.prototype.uploadAvatar=function(a){var c=f.getNode(a.to),c="groupchat"==a.type?f.buildChatGroupJID(c):f.buildUserJID(c);FileUpload.getInstance(a.fileInputId,{fileTypeExts:"jpg;jpeg;png;bmp;gif",fileSizeLimit:5120,breakPoints:!1,saveInfoLocal:!1,removeTimeout:100,uploader:m.SERVLET.FILE_UPLOAD_SERVLET,uploadIdPrefix:"user_avatar_upload_",inputId:a.fileInputId,to:c,type:UPLOAD_AVATAR,onUploadSuccess:a.success,onUploadError:a.error,showProcess:!1,processId:"udnProcessBar"});FileUpload.getInstance(a.fileInputId).sendFile(document.getElementById(a.fileInputId))};
h.prototype.getServerName=function(){return m.CONNECTION.SERVER_NAME};h.prototype.getTransformFileList=function(a){jQuery.ajax({url:m.SERVLET.REST_TRANSFORM_SERVLET+"docInfo",type:"get",data:{attachId:a.attachId,token:this.getToken(),downloader:this.getUserNode()},dataType:"json",cache:!1,success:function(c){a.success&&a.success(c)},error:function(){a.error&&a.error()},complete:function(){a.complete&&a.complete()}})};h.prototype.getFileUrl=function(a){var c,d;this.isAnonymous()?(c=this.getUserFullJID(),
d="anonymous"):(c=this.getUserNode(),d=this.getToken());return m.SERVLET.FILE_DOWNLOAD_SERVLET+"?attachId="+a+"&fromUser="+c+"&token="+d};h.prototype.getServletPath=function(){return m.SERVLET};h.prototype.getJIDUtil=function(){return f};h.prototype.getArrayUtil=function(){return YYIMArrayUtil};h.prototype.isAnonymous=function(){return this._anonymousUser};h.prototype.enableAnonymous=function(){return m.IS_ANONYMOUS};h.prototype.getBrowser=function(){return m.BROWSER};h.prototype.isOnline=function(a){return!0==
A.getInstance()._onlineList.get(a)};h.prototype.multiPartyCall=function(a){if("undefined"!==typeof a&&"undefined"!==typeof a.caller&&YYIMArrayUtil.isArray(a.phones)&&a.phones.length)if(YYIMRegularUtil.phone.test(a.caller)){var c=[],d;for(d in a.phones){var e=a.phones[d].toString();if(YYIMRegularUtil.phone.test(e)&&-1===c.indexOf(e)&&(c.push(e),e=c.join(","),c.length>m.MULTIPARTYCALL.PARTYMAXLENGTH||e.length>m.MULTIPARTYCALL.PHONESMAXLENGTH)){c.pop();break}}if(c.length){a.caller=a.caller.toString();
a.phones=c;if(!0!==a.accountMmanaged&&(a.phones=c.join(","),a.account=a.account?a.account:m.MULTIPARTYCALL.ACCOUNT,a.key=a.key?a.key:m.MULTIPARTYCALL.KEY,"undefined"===typeof a.account||"undefined"===typeof a.key)){a.error&&a.error();return}M.multiPartyCall(a)}else a.error&&a.error()}else a.error&&a.error();else a.error&&a.error()};h.prototype.getTimeCorrection=function(a){M.getTimeCorrection(a)};h.prototype.operateWhiteBoard=function(a){var c={id:Math.uuid(),origin:a.origin,operation:a.operation||
"create",success:a.success,error:a.error,complete:a.complete};"create"!==a.operation&&(c.wid=a.wid);if("create"===a.operation||"rename"===a.operation)c.name=a.name;c.wid&&c.origin&&"listen"===c.operation?G.listenWhiteBoard(c):!c.origin||"create"!==c.operation&&"end"!==c.operation&&"rename"!==c.operation?a.error&&a.error():G.operateWhiteBoard(c)};h.prototype.updateWhiteBoard=function(a){a.wid&&a.nodeId?(a.id=Math.uuid(),a.from=h.getInstance().getUserFullJID(),a.operation="delete"===a.operation?"delete":
"update","update"!=a.operation||a.nodeContent?G.updateWhiteBoard(a):a.error&&a.error()):a.error&&a.error()};return h.getInstance()}();
