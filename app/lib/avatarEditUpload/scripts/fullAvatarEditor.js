function fullAvatarEditor() {
	...
	var file			= 'message/angular/lib/avatarEditUpload/fullAvatarEditor.swf';		//flash文件的路径
	var	version			= "10.1.0";						//播放该flash所需的最低版本
	var	expressInstall	= 'message/angular/lib/avatarEditUpload/expressInstall.swf';			//expressInstall.swf的路径
	var	width			= 700;							//flash文件的宽度
