...
var webUrl = {
	...
	qzInfo:{
		host:'https://pc-api.esn.ren'//"http://pc.api.esn.ren:6062"
	},
	yxim:{
		appId:'esn',//"esntest",
		etpId: "upesn",
		address: 'stellar.upesn.com',//'im01.upesn.com',
      	wsport: 5222,
      	hbport: 7070,
      	servlet: 'https://im.upesn.com/',//'https://im01.upesn.com/',
      	safeServlet: 'https://im.upesn.com/'//'https://im01.upesn.com/'
	}
